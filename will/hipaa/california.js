...
window.HIPAA_STATES["California"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  CALIFORNIA
...
#! California Medical Information Authorization — Civil Code § 56.11

This Authorization is intended to satisfy California Civil Code § 56.11 as well as HIPAA. It identifies the information to be disclosed, the persons or functions authorized to disclose it, the persons or functions authorized to receive it, the specific uses and limitations on disclosure and use, and an expiration date or event. The signer is entitled to a copy.

[[if authorize_hiv_sti]]

I specifically authorize disclosure of HIV test results and HIV-related information. For purposes of California Health and Safety Code § 120980(g), this written authorization applies to disclosure by persons responsible for my care and treatment to the recipient(s) identified in this Authorization.

[[end]]

#! California Duration Limitation.

For medical information governed by California Civil Code § 56.11, the expiration date or event must comply with the statutory duration limitations. The generated authorization shall not use a duration longer than California law permits unless the signer has requested a specific later date or a statutory exception applies.

#! California Copy Requirement.

The person or entity obtaining this Authorization shall provide the signer a copy of the signed Authorization and instructions for obtaining additional copies or a digital version, as required by California Civil Code § 56.11(c).
