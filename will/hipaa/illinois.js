...
window.HIPAA_STATES["Illinois"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  ILLINOIS
...
#! State-Specific Authorization — Illinois

This Authorization is intended to satisfy applicable Illinois requirements for mental-health and HIV-related information, including 740 ILCS 110/5 and 410 ILCS 305/9.

[[if authorize_mental_health]]

I specifically consent to disclosure of mental-health and developmental-disability records and communications. The recipient(s), purpose, nature of information, right to inspect and copy the information, consequences of refusal (if any), expiration date, and right to revoke are stated in this Authorization as required by 740 ILCS 110/5. Only information relevant to the stated purpose may be disclosed; blanket consent to unspecified mental-health information is not intended.

[[end]]

#! Illinois Mental-Health Right to Inspect.

For information governed by 740 ILCS 110/5, I understand that I have the right to inspect and copy the information to be disclosed. Consequences of refusal to consent: none, except as otherwise permitted by law or necessary for a transaction specifically requested by me.

[[if authorize_hiv_sti]]

I specifically authorize release of HIV-related information to the recipient(s) identified in this Authorization as a legally effective authorization under 410 ILCS 305/9.
