...
window.HIPAA_STATES["Georgia"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  GEORGIA
...
#! State-Specific Authorization — Georgia

This Authorization is intended to operate together with Georgia confidentiality law, including O.C.G.A. §§ 24-12-21 and 37-3-166.

[[if authorize_hiv_sti]]

I designate in writing the recipient(s) identified in this Authorization to receive AIDS/HIV confidential information protected by O.C.G.A. § 24-12-21.

[[end]]

[[if authorize_mental_health]]

I designate in writing the recipient(s) identified in this Authorization to receive the mental-health clinical record or information described here, to the extent release is permitted under O.C.G.A. § 37-3-166.
