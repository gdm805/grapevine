...
window.HIPAA_STATES["New Hampshire"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  NEW HAMPSHIRE
...
#! State-Specific Authorization — New Hampshire

This Authorization is intended to operate together with New Hampshire medical confidentiality law, including RSA 329:26, RSA 330-A:32, RSA 135-C:19-a, and RSA 141-C:10.

[[if authorize_mental_health]]

I consent in writing to disclosure of mental-health information to the recipient(s) identified in this Authorization to the extent consent is requested or required under RSA 135-C:19-a and other applicable New Hampshire law.

[[end]]

[[if authorize_hiv_sti]]

I give informed written consent to release communicable-disease protected health information to the recipient(s) identified in this Authorization under RSA 141-C:10.
