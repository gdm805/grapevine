...
window.HIPAA_STATES["Connecticut"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  CONNECTICUT
...
#! State-Specific Authorization — Connecticut

This Authorization is intended to satisfy applicable Connecticut requirements for specially protected mental-health and HIV-related information, including Conn. Gen. Stat. §§ 52-146e and 19a-581 through 19a-585.

[[if authorize_mental_health]]

I consent to disclosure of confidential mental-health communications and records to the recipient(s) identified in this Authorization for the uses stated in this Authorization. I understand that refusal to grant consent will not jeopardize my right to obtain present or future treatment except where disclosure is necessary for the treatment, and that I may withdraw this consent in writing as provided by Conn. Gen. Stat. § 52-146e.

[[end]]

[[if authorize_hiv_sti]]

I specifically authorize disclosure of confidential HIV-related information. This release is dated, identifies to whom disclosure is authorized, states the purpose for disclosure, and states the time period for which the release is effective, as required by Connecticut law. A general authorization alone is not intended to substitute for this specific HIV authorization.
