...
window.HIPAA_STATES["Wisconsin"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  WISCONSIN
...
@center **WISCONSIN HIPAA AUTHORIZATION**
...
#! Wisconsin State-Specific Provisions
...
#! Wisconsin Treatment-Record Consent Elements

For treatment records governed by Wisconsin mental-health, developmental-disability, alcoholism, or drug-dependence confidentiality law, this authorization is intended to constitute informed written consent. The recipient is identified above; the subject individual is {{name}}; the purpose is stated above; the specific types of information are identified in this document; the effective period is stated in the duration and expiration provisions; and the authorization is dated and signed below.

#! Mental Health, Developmental Disability, Alcoholism, And Drug Dependence Records

I specifically authorize disclosure of treatment records relating to mental illness, developmental disabilities, alcoholism, or drug dependence to the fullest extent my informed written consent permits under Wisconsin law.

#! Substance Use Disorder Information

Any disclosure of substance use disorder diagnosis, treatment, or referral information remains subject to applicable federal restrictions, including restrictions that cannot lawfully be waived by this authorization.
...
Wis. Stat. §§ 51.30 and 146.82; 45 C.F.R. Parts 160 and 164; 42 C.F.R. Part 2.
