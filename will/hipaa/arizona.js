...
window.HIPAA_STATES["Arizona"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  ARIZONA
...
#! State-Specific Authorization — Arizona

This Authorization is intended to satisfy applicable Arizona medical-record and communicable-disease authorization requirements, including A.R.S. §§ 12-2294 and 36-664.

[[if authorize_hiv_sti]]

I specifically authorize release of confidential HIV-related information. This is intended to be an authorization for release of confidential HIV-related information under A.R.S. § 36-664. The authorized recipient(s), purpose, and duration are those stated in this Authorization.

[[end]]

#! Arizona Redisclosure Limitation.

A recipient of communicable-disease-related information remains subject to the redisclosure limits imposed by A.R.S. § 36-664.
