...
window.HIPAA_STATES["New Jersey"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  NEW JERSEY
...
#! State-Specific Authorization — New Jersey

This Authorization is intended to operate together with New Jersey medical confidentiality law and N.J.S.A. 26:5C-7 through 26:5C-12 concerning AIDS/HIV records.

[[if authorize_hiv_sti]]

I give prior written informed consent to disclosure of records containing identifying information concerning AIDS or HIV infection to the recipient(s) identified in this Authorization, pursuant to N.J.S.A. 26:5C-8.

[[end]]

[[if authorize_mental_health]]

I specifically authorize disclosure of mental-health records to the recipient(s) identified in this Authorization to the extent patient authorization is required by New Jersey law.
