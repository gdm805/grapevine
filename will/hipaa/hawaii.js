...
window.HIPAA_STATES["Hawaii"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  HAWAII
...
#! State-Specific Authorization — Hawaii

This Authorization is intended to operate together with Hawaii confidentiality law, including HRS §§ 325-101 and 334-5.

[[if authorize_hiv_sti]]

I give prior written consent to release records indicating HIV infection, ARC, or AIDS, including specific medical or epidemiological information, to the recipient(s) identified in this Authorization under HRS § 325-101. I understand that persons receiving such information remain subject to Hawaii confidentiality restrictions.

[[end]]

[[if authorize_mental_health]]

I authorize disclosure of mental-health records to the extent permitted by HRS § 334-5 and HIPAA.
