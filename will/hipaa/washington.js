...
window.HIPAA_STATES["Washington"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  WASHINGTON
...
@center **WASHINGTON HIPAA AUTHORIZATION**
...
#! Washington Authorization Elements

This authorization is written, dated when signed, identifies the patient, identifies the nature of the information to be disclosed, identifies the provider or class of providers authorized to disclose it, identifies the person or class of persons authorized to receive it, and states an expiration date or event through the expiration field above. It is intended to satisfy the disclosure-authorization elements required by Washington law.

#! Specially Protected Records

I specifically authorize disclosure of mental-health records, substance use disorder records, HIV or sexually transmitted disease information, and reproductive-health information to the extent a specific authorization is required and legally sufficient under Washington and federal law.
...
RCW 70.02.020, 70.02.030 and related provisions of chapter 70.02 RCW; 45 C.F.R. Parts 160 and 164; 42 C.F.R. Part 2.
