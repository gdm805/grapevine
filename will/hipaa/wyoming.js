...
window.HIPAA_STATES["Wyoming"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  WYOMING
...
@center **WYOMING HIPAA AUTHORIZATION**
...
#! Wyoming State-Specific Provisions
...
I authorize any hospital or other covered health care provider holding my health care information to disclose the information described in this authorization to the persons identified above, subject to applicable state and federal law.

#! Mental Health Information

I specifically authorize disclosure of mental-health information and confidential communications to the extent I may waive confidentiality or privilege and authorize disclosure under Wyoming law. This authorization does not compel disclosure where a provider may lawfully deny or limit access.

#! Substance Use Disorder Information

I specifically authorize disclosure of substance use disorder diagnosis, treatment, and referral information to the extent permitted by applicable federal and Wyoming law. Any disclosure remains subject to federal restrictions that cannot lawfully be waived.
...
Wyo. Stat. §§ 35-2-607, 35-2-610 to 35-2-612, and applicable professional-confidentiality provisions; 45 C.F.R. Parts 160 and 164; 42 C.F.R. Part 2.
