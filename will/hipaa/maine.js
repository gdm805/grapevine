...
window.HIPAA_STATES["Maine"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  MAINE
...
#! State-Specific Authorization — Maine

This Authorization is intended to satisfy 22 M.R.S. § 1711-C as well as HIPAA. It states the signer’s name and signature/date, the persons authorized to disclose, the nature of the information, the recipient, the specific purpose, the duration, the consequences of refusal, the right and method to revoke, and the signer’s right to a copy.

#! Maine Duration Limitation

For disclosures governed by 22 M.R.S. § 1711-C, the authorization may not extend longer than 30 months unless a statutory exception applies.

[[if authorize_hiv_sti]]

MAINE HIV INFORMATION — SEPARATE AUTHORIZATION. I specifically authorize release of HIV infection status information and HIV test results under 5 M.R.S. §§ 19203 and 19203-D. I understand that a general release is insufficient when HIV release has not otherwise been elected, and that I am specifically authorizing release of that information here. Recipient(s): {{specialty_recipients}}. Purpose: {{specialty_purpose}}.

[[end]]

[[if authorize_hiv_sti]]

Separate Maine HIV Signature: ____________________________________    Date: ______
