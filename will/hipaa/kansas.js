...
window.HIPAA_STATES["Kansas"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  KANSAS
...
#! State-Specific Authorization — Kansas

This Authorization is intended to operate together with K.S.A. 65-6825 and other applicable Kansas confidentiality law. Kansas generally permits use and disclosure of protected health information pursuant to an authorization satisfying 45 C.F.R. § 164.508.

[[if authorize_mental_health]]

I specifically consent in writing to disclosure of mental-health treatment and medical records protected by K.S.A. 59-2979 and, where applicable, K.S.A. 59-29b79, to the recipient(s) identified in this Authorization.
