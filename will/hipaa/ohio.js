...
window.HIPAA_STATES["Ohio"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  OHIO
...
@center **OHIO HIPAA AUTHORIZATION**
...
#! Ohio State-Specific Provisions
...
#! HIV-Related Information - Specific Authorization

I specifically authorize disclosure of HIV-related test results, diagnoses, treatment information, and other HIV-related information to the extent my written authorization may lawfully permit disclosure. This paragraph is intended as a specific authorization and not merely as a general medical-records release.

#! Behavioral Health Information

I specifically authorize disclosure of records concerning mental-health conditions, assessments, care, treatment, recovery supports, and payment for such services to the extent disclosure may be authorized by the person identified in those records or that person's legally authorized representative.

#! Substance Use Disorder Information

I specifically authorize disclosure of substance use disorder diagnosis, treatment, and referral information to the extent permitted by applicable Ohio and federal law, including any consent requirements that cannot be waived by a general HIPAA authorization.
...
Ohio Rev. Code §§ 3701.243 and 5119.28; 45 C.F.R. Parts 160 and 164; 42 C.F.R. Part 2, as applicable.
