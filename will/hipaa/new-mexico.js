...
window.HIPAA_STATES["New Mexico"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  NEW MEXICO
...
@center **NEW MEXICO HIPAA AUTHORIZATION**
...
#! New Mexico State-Specific Provisions
...
I specifically authorize the use and disclosure of confidential mental-health and developmental-disability information to the fullest extent permitted by New Mexico law, including information protected by the New Mexico Mental Health and Developmental Disabilities Code. This authorization is intended to constitute my express authorization for disclosure whenever my authorization is legally sufficient. If applicable law requires a court-appointed guardian, treatment guardian, or other legally authorized representative to consent for a person who lacks legal capacity to authorize disclosure, this authorization does not eliminate that requirement.

#! Substance Use Disorder Information

I specifically authorize disclosure of records relating to substance use disorder diagnosis, treatment, or referral for treatment to the extent such disclosure may be authorized by me under applicable federal and New Mexico law. Any disclosure remains subject to restrictions that cannot lawfully be waived by this authorization.
...
N.M. Stat. § 43-1-19; 45 C.F.R. Parts 160 and 164.
