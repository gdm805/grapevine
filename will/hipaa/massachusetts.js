...
window.HIPAA_STATES["Massachusetts"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  MASSACHUSETTS
...
#! State-Specific Authorization — Massachusetts

This Authorization is intended to operate together with Massachusetts medical-record confidentiality law, including G.L. c. 111, §§ 70 and 70E.

[[if authorize_hiv_sti]]

MASSACHUSETTS HIV INFORMATION — SEPARATE WRITTEN INFORMED CONSENT. I specifically consent to disclosure of HIV antibody or antigen test results and medical records containing such information under G.L. c. 111, § 70F. Purpose: {{specialty_purpose}}. Recipient(s): {{specialty_recipients}}. This HIV consent is separately distinguished from my authorization for release of other medical information.

[[end]]

[[if authorize_hiv_sti]]

Separate Massachusetts HIV Signature: ____________________________________    Date: ______
