...
window.HIPAA_STATES["Indiana"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  INDIANA
...
#! State-Specific Authorization — Indiana

This Authorization is intended to satisfy Indiana mental-health record-release requirements under IC 16-39-2-5.

[[if authorize_mental_health]]

For release of mental-health records, this written request identifies the patient, the person requested to release the record, the recipient, the purpose, the information to be released, the signer, the date, the right of revocation, and an expiration date, event, or condition as required by IC 16-39-2-5(c). Unless the generated Authorization expressly states a shorter period, the state-law mental-health authorization shall not be treated as continuing beyond the period permitted by Indiana law.
