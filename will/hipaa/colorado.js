...
window.HIPAA_STATES["Colorado"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  COLORADO
...
#! State-Specific Authorization — Colorado

This Authorization is intended to operate together with Colorado confidentiality law, including C.R.S. § 27-65-123.

[[if authorize_mental_health]]

I designate the recipient(s) identified in this Authorization as persons to whom information and records protected by C.R.S. § 27-65-123 may be released, to the extent I have authority to make that designation.
