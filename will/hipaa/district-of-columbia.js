...
window.HIPAA_STATES["District of Columbia"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  DISTRICT OF COLUMBIA
...
@center **DISTRICT OF COLUMBIA HIPAA AUTHORIZATION**
...
#! District of Columbia State-Specific Provisions
...
#! Clear, Conspicuous, And Specific Authorization

This authorization is intended to be clear, conspicuous, and specific as to the medical records authorized for disclosure, the persons authorized to receive them, and the purpose and duration of the authorization.

#! Mental Health Information

I specifically authorize disclosure of my mental-health information to the persons identified in this authorization. I understand that District law permits an adult client or client representative to authorize disclosure, but a mental health professional may in limited circumstances refuse or limit an otherwise authorized disclosure when statutory safety criteria are met.

#! Substance Use Disorder Information

I specifically authorize disclosure of substance use disorder diagnosis, treatment, and referral information to the extent permitted by applicable federal and District law. Any disclosure remains subject to federal restrictions that cannot lawfully be waived.
...
D.C. Code §§ 7-1202.05, 7-1202.06, and 3-1210.12; 45 C.F.R. Parts 160 and 164; 42 C.F.R. Part 2.
