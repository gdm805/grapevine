...
window.HIPAA_STATES["Nebraska"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  NEBRASKA
...
#! State-Specific Authorization — Nebraska

This Authorization is intended to operate together with Nebraska confidentiality law governing health and mental-health records.

[[if authorize_mental_health]]

I give written permission for disclosure of mental-health records protected by Neb. Rev. Stat. § 71-961 and written consent for disclosure by mental-health practitioners under Neb. Rev. Stat. § 38-2136, to the recipient(s) identified in this Authorization.

[[end]]

[[if authorize_hiv_sti]]

I give written consent to release information or test results protected by Neb. Rev. Stat. § 71-511 to the recipient(s) identified in this Authorization.
