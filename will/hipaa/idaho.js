...
window.HIPAA_STATES["Idaho"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  IDAHO
...
#! State-Specific Authorization — Idaho

This Authorization is intended to operate together with Idaho confidentiality law, including Idaho Code §§ 66-348 and 39-4505.

[[if authorize_mental_health]]

I consent to disclosure of records protected by Idaho Code § 66-348 to the recipient(s) identified in this Authorization.

[[end]]

[[if authorize_hiv_sti]]

I specifically authorize disclosure of blood-test or body-fluid-test results concerning HIV or other blood-transmitted or body-fluid-transmitted disease to the extent a written authorization is required under Idaho Code § 39-4505.
