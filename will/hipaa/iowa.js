...
window.HIPAA_STATES["Iowa"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  IOWA
...
#! State-Specific Authorization — Iowa

This Authorization is intended to satisfy Iowa Code §§ 228.3 and 228.4 for voluntary disclosure of mental-health information.

[[if authorize_mental_health]]

I voluntarily authorize disclosure of the mental-health information described in this Authorization. The Authorization identifies the nature of the information, the persons or types of persons authorized to disclose it, the purposes for present and future use, the duration, and the date signed. I understand my right to inspect the disclosed mental-health information at any time and my right to revoke as provided by Iowa Code §§ 228.3 and 228.4.

[[end]]

#! Iowa Copy Requirement.

A copy of an authorization for mental-health information governed by Iowa Code § 228.3 shall be provided to the individual or legal representative and included in the individual’s mental-health record.
