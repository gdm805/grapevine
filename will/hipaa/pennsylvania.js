...
window.HIPAA_STATES["Pennsylvania"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  PENNSYLVANIA
...
@center **PENNSYLVANIA HIPAA AUTHORIZATION**
...
#! Pennsylvania State-Specific Provisions
...
I specifically authorize disclosure of mental-health records and information to the extent I, my legally authorized representative, or an authorized mental-health care agent may consent to disclosure under Pennsylvania law. This authorization is intended to supplement, and not limit, any disclosure authority granted to an acting agent under a valid mental-health advance directive.

#! Substance Use Disorder Information

I specifically authorize disclosure of substance use disorder diagnosis, treatment, and referral information to the extent permitted by applicable Pennsylvania and federal law, including any consent and redisclosure restrictions that remain mandatory.
...
Pennsylvania Mental Health Procedures Act and Mental Health Advance Directive law, as applicable; 45 C.F.R. Parts 160 and 164; 42 C.F.R. Part 2, as applicable.
