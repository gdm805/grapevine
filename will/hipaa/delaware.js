...
window.HIPAA_STATES["Delaware"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  DELAWARE
...
#! State-Specific Authorization — Delaware

This Authorization is intended to operate together with Delaware confidentiality law, including 16 Del. C. §§ 717 and 1201 through 1205.

[[if authorize_hiv_sti]]

I specifically authorize disclosure of HIV-related test information to the recipient(s) identified in this Authorization as a legally effective release under 16 Del. C. § 717.

[[end]]

[[if authorize_genetic]]

I specifically consent to disclosure of genetic information under 16 Del. C. § 1201(4). The genetic information to be disclosed is: {{genetic_description}}. The information may be disclosed to the recipient(s) identified in this Authorization.
