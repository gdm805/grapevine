...
window.HIPAA_STATES["Missouri"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  MISSOURI
...
#! State-Specific Authorization — Missouri

This Authorization is intended to operate together with Missouri medical-record and confidentiality law, including RSMo §§ 191.227 and 191.656.

[[if authorize_hiv_sti]]

I specifically authorize disclosure of confidential HIV infection status and HIV testing information to the recipient(s) identified in this Authorization to the extent permitted by RSMo § 191.656.

[[end]]

[[if authorize_mental_health]]

I consent to disclosure of mental-health information to the recipient(s) and for the purposes stated in this Authorization to the extent Missouri law requires patient consent for the requested disclosure.
