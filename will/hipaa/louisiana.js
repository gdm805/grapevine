...
window.HIPAA_STATES["Louisiana"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  LOUISIANA
...
#! State-Specific Authorization — Louisiana

This Authorization is intended to operate together with Louisiana medical-record confidentiality law and La. R.S. 40:1171.1 through 40:1171.5 concerning HIV test results.

[[if authorize_hiv_sti]]

I specifically authorize release of confidential HIV test results to the recipient(s) identified in this Authorization. I do not refuse release of HIV test results. This authorization is intended to function as a release of confidential HIV test results under La. R.S. 40:1171.4.

[[end]]

#! Louisiana HIV Redisclosure Limitation

A person receiving confidential HIV test results remains subject to the redisclosure restrictions of La. R.S. 40:1171.4.

[[if authorize_mental_health]]

I specifically authorize disclosure of mental-health records and privileged treatment information to the extent Louisiana law permits disclosure upon the patient’s written authorization.
