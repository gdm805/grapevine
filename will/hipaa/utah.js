...
window.HIPAA_STATES["Utah"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  UTAH
...
@center **UTAH HIPAA AUTHORIZATION**
...
I specifically authorize disclosure of records relating to my mental health, substance use, and other behavioral health services to the extent disclosure may be authorized by me under applicable Utah and federal law.

#! Specially Protected Information

This authorization is intended to include specially protected health information only when my express authorization is legally sufficient. A provider may require a separate or more specific consent where state or federal law imposes additional requirements.

#! Substance Use Disorder Information

I specifically authorize disclosure of substance use disorder diagnosis, treatment, and referral information to the extent permitted by applicable federal and Utah law. Any disclosure remains subject to federal restrictions that cannot lawfully be waived.
...
Utah Code Title 26B, Chapter 5; 45 C.F.R. Parts 160 and 164; 42 C.F.R. Part 2.
