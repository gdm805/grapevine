...
window.HIPAA_STATES["Alabama"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  ALABAMA
...
#! State-Specific Authorization — Alabama

This Authorization is intended to operate together with applicable Alabama confidentiality law, including Ala. Code § 22-11A-22.

[[if authorize_hiv_sti]]

I specifically authorize disclosure of records concerning sexually transmitted diseases, including HIV-related information to the extent protected by Ala. Code § 22-11A-22. I understand that Alabama law treats such records as confidential and permits release of individual medical records upon the patient’s written consent.
...
Alabama law does not impose a separate witness or notarization requirement for this general written health-information authorization. The Principal’s signature and date execute this Authorization; any specially protected record is released only to the extent the applicable Alabama statute permits.
