...
window.HIPAA_STATES["South Dakota"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  SOUTH DAKOTA
...
@center **SOUTH DAKOTA HIPAA AUTHORIZATION**
...
#! South Dakota State-Specific Provisions
...
I specifically authorize disclosure of my medical records to the persons identified in this authorization. This document is intended to operate as my written request and authorization for release of available medical records to the extent permitted by South Dakota law.

#! Mental Health Information

I specifically consent to disclosure of confidential information acquired in the course of providing mental health services, to the fullest extent I may lawfully authorize. I understand that South Dakota law separately protects mental health records and that disclosures remain subject to any limitations that cannot be waived.

#! Substance Use Disorder Information

I specifically authorize disclosure of substance use disorder diagnosis, treatment, and referral information to the extent permitted by applicable federal and South Dakota law. Any disclosure remains subject to federal restrictions that cannot lawfully be waived.
...
S.D. Codified Laws §§ 34-12-15, 36-2-16.2, 27A-12-26 to 27A-12-32; 45 C.F.R. Parts 160 and 164; 42 C.F.R. Part 2.
