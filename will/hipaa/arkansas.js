...
window.HIPAA_STATES["Arkansas"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  ARKANSAS
...
#! State-Specific Authorization — Arkansas

This Authorization is intended to operate together with Arkansas confidentiality law, including Ark. Code Ann. § 20-15-904.

[[if authorize_hiv_sti]]

I specifically authorize disclosure of HIV/AIDS information contained in my medical record to the extent disclosure may lawfully be made by the record holder. This Authorization does not purport to override the separate confidentiality protections applicable to HIV/AIDS reports maintained under Ark. Code Ann. § 20-15-904.
