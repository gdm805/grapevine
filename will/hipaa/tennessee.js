...
window.HIPAA_STATES["Tennessee"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  TENNESSEE
...
@center **TENNESSEE HIPAA AUTHORIZATION**
...
I authorize hospitals and other health care providers to furnish the records described in this authorization to my authorized recipient upon written request, subject to restrictions imposed by state or federal law.

#! Mental Health And Developmental Disability Information

I specifically authorize disclosure of confidential records and information concerning mental health, substance-use, and intellectual or developmental-disability services to the extent my consent permits disclosure under Tennessee law.

#! Substance Use Disorder Information

I specifically authorize disclosure of substance use disorder diagnosis, treatment, and referral information to the extent permitted by applicable federal and Tennessee law. Any disclosure remains subject to federal restrictions that cannot lawfully be waived.
...
Tenn. Code Ann. §§ 68-11-304, 33-3-103 to 33-3-105; 45 C.F.R. Parts 160 and 164; 42 C.F.R. Part 2.
