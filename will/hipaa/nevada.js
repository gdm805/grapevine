...
window.HIPAA_STATES["Nevada"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  NEVADA
...
#! State-Specific Authorization — Nevada

This Authorization is intended to operate together with Nevada health-care-record law, including NRS Chapter 629.

[[if authorize_mental_health]]

I specifically authorize in writing release of clinical mental-health records protected by NRS 433A.360 to the recipient(s) identified in this Authorization.

[[end]]

[[if authorize_hiv_sti]]

I consent in writing to disclosure of communicable-disease information to the extent such information is protected by NRS Chapter 441A.
