...
window.HIPAA_STATES["Vermont"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  VERMONT
...
@center **VERMONT HIPAA AUTHORIZATION**
...
#! Vermont State-Specific Provisions
...
I specifically consent in writing to disclosure of confidential mental-health records and clinical information to the persons identified in this authorization. To the extent permitted by Vermont law, this consent may also be exercised by my agent under a valid advance directive or other legally authorized representative.

#! HIV And AIDS Information

I specifically authorize disclosure of HIV- and AIDS-related health information to the extent my written authorization is required and legally sufficient under Vermont law.

#! Substance Use Disorder Information

I specifically authorize disclosure of substance use disorder diagnosis, treatment, and referral information to the extent permitted by applicable federal and Vermont law. Any disclosure remains subject to federal restrictions that cannot lawfully be waived.
...
18 V.S.A. §§ 7103 and 1001 et seq. (as applicable); 45 C.F.R. Parts 160 and 164; 42 C.F.R. Part 2.
