...
window.HIPAA_STATES["Kentucky"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  KENTUCKY
...
#! State-Specific Authorization — Kentucky

This Authorization is intended to operate together with applicable Kentucky confidentiality law, including KRS 214.181 and KRS 304.17A-555.

[[if authorize_hiv_sti]]

I specifically authorize disclosure of HIV test results and HIV-related information to the recipient(s) identified in this Authorization. This clause is intended to constitute a legally effective release of HIV test results under KRS 214.181.

[[end]]

#! Kentucky HIV Redisclosure Notice

When HIV information is disclosed under KRS 214.181, the disclosure is subject to Kentucky’s statutory prohibition on further disclosure without the specific written consent of the person to whom the information pertains or as otherwise permitted by state law; a general medical authorization is not sufficient for that further disclosure.

[[if authorize_mental_health]]

I specifically authorize disclosure of mental-health or chemical-dependency information to the extent a specific written consent is required by Kentucky law, including KRS 304.17A-555.
