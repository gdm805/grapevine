...
window.HIPAA_STATES["Florida"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  FLORIDA
...
#! State-Specific Authorization — Florida

This Authorization is intended to operate together with Florida confidentiality law, including Fla. Stat. §§ 381.004 and 394.4615.

[[if authorize_hiv_sti]]

I specifically authorize disclosure of my HIV test results and related HIV information to the recipient(s) identified in this Authorization. I understand that a general release of medical information, without the specific written authorization required by Fla. Stat. § 381.004, is not sufficient for HIV test results.

[[end]]

[[if authorize_mental_health]]

I expressly and knowingly authorize release of clinical mental-health records protected by Fla. Stat. § 394.4615 to the recipient(s) identified in this Authorization.

[[end]]

#! Florida HIV Redisclosure Notice.

When HIV test results are disclosed, the disclosing person must provide the state-law confidentiality/redisclosure notice required by Fla. Stat. § 381.004. This Authorization does not eliminate that duty.
