...
window.HIPAA_STATES["Minnesota"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  MINNESOTA
...
#! State-Specific Authorization — Minnesota

This Authorization is intended to satisfy Minn. Stat. § 144.293. It is a signed and dated consent authorizing release of health records to the recipient(s) identified in this Authorization.

#! Minnesota Duration

Unless a different period is expressly stated in this Authorization or a different period is provided by Minnesota law, consent under Minn. Stat. § 144.293 is valid for one year.

[[if authorize_mental_health]]

I specifically authorize disclosure of mental-health records subject to Minn. Stat. §§ 144.293 and 144.294 to the recipient(s) identified in this Authorization.
