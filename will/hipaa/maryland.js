...
window.HIPAA_STATES["Maryland"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  MARYLAND
...
#! State-Specific Authorization — Maryland

This Authorization is intended to operate together with the Maryland Confidentiality of Medical Records Act, Md. Code, Health-General §§ 4-301 through 4-309.

[[if authorize_mental_health]]

I specifically authorize disclosure of medical records developed in connection with mental-health services to the recipient(s) identified in this Authorization, subject to Md. Code, Health-General § 4-307 and the limitations applicable to psychological testing, group or family therapy records, and other specially protected material.
