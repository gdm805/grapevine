...
window.HIPAA_STATES["Michigan"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  MICHIGAN
...
#! State-Specific Authorization — Michigan

This Authorization is intended to operate together with Michigan confidentiality law, including the Mental Health Code, MCL 330.1748, and HIV confidentiality provisions of the Public Health Code.

[[if authorize_mental_health]]

I specifically authorize disclosure of behavioral-health and mental-health information for clinical purposes to the recipient(s) identified in this Authorization, to the extent authorized by MCL 330.1748. Michigan providers that are required to use or honor the current MDHHS Behavioral Health Standard Consent Form (MDHHS-5515) shall treat this authorization consistently with those requirements; if the state-mandated form is required for the requested disclosure, the provider may require that form in addition to this Authorization.

[[end]]

[[if authorize_hiv_sti]]

I expressly authorize in writing disclosure of information pertaining to HIV infection or AIDS. This authorization is specific to HIV infection/AIDS as required by Michigan law and is not intended to rely solely on a general medical-record release.
