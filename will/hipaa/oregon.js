...
window.HIPAA_STATES["Oregon"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  OREGON
...
@center **OREGON HIPAA AUTHORIZATION**
...
#! Oregon State-Specific Provisions
...
#! Specially Protected Information - Express Selection

I specifically authorize disclosure of each category I initial below, to the extent an express authorization is required by Oregon or federal law.
...
_____ Drug or alcohol diagnosis, treatment, or referral information

#! Expiration

This authorization expires on the date or event stated below. If no valid expiration is stated, it expires only to the extent allowed by applicable law.

Expiration date or event: ______________________________________________
...
Or. Rev. Stat. §§ 192.553-192.581, including § 192.566; 45 C.F.R. Parts 160 and 164.
