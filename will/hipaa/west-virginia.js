...
window.HIPAA_STATES["West Virginia"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  WEST VIRGINIA
...
@center **WEST VIRGINIA HIPAA AUTHORIZATION**
...
#! West Virginia State-Specific Provisions
...
I specifically authorize in writing the transmission and disclosure of confidential mental-health information to the persons identified in this authorization. I understand that I should receive a copy of an authorization for disclosure of such information and that refusal to authorize disclosure may not be used to jeopardize my right to obtain present or future treatment.

#! HIV-Related Information

I specifically authorize release of my HIV-related test results and identifying HIV-related information to the persons identified in this authorization to the extent a specific release by me is legally sufficient under West Virginia law.

#! Substance Use Disorder Information

I specifically authorize disclosure of substance use disorder diagnosis, treatment, and referral information to the extent permitted by applicable federal and West Virginia law. Any disclosure remains subject to federal restrictions that cannot lawfully be waived.
...
W. Va. Code §§ 16-29-1, 16-29-2, 27-3-2, 16-3C-3 and 16-3C-4; 45 C.F.R. Parts 160 and 164; 42 C.F.R. Part 2.
