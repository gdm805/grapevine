...
window.HIPAA_STATES["Texas"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HIPAA AUTHORIZATION  |  TEXAS
...
@center **TEXAS HIPAA AUTHORIZATION**
...
#! Texas Electronic Disclosure Rule

Texas law may require a separate authorization for each electronic disclosure of protected health information unless an exception applies. This authorization expresses my consent to electronic disclosure, but a covered entity may require or document an additional disclosure-specific authorization under Texas law. Nothing in this document is intended to eliminate that separate-authorization requirement.

#! Mental Health Information

I specifically consent in writing to disclosure of confidential mental-health information and records to the persons identified in this authorization, to the fullest extent permitted by Texas law.

#! Substance Use Disorder Information

I specifically authorize disclosure of substance use disorder diagnosis, treatment, and referral information to the extent permitted by applicable federal and Texas law. Any disclosure remains subject to federal restrictions that cannot lawfully be waived.
...
Tex. Health & Safety Code §§ 181.154, 611.004, 611.0045; 45 C.F.R. Parts 160 and 164; 42 C.F.R. Part 2.
