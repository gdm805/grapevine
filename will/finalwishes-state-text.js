...
[[elif signing_state=HAWAII]]
// DRAFTER NOTE: Hawaii standalone disposition directions/designation use the notarial execution route.
...
@sub Agent's Acceptance

I, {{agent_name}}, accept this designation as agent to direct the disposition of the remains of {{name}}, and agree to act subject to applicable law and the directions stated in this document.
@line Signature: ________________________________________
@line Date: _____________________________________________
[[if has_alt_agent]]

@sub Successor Agent's Acceptance

I, {{alt_agent_name}}, accept this designation as successor agent to direct the disposition of the remains of {{name}}, and agree to act subject to applicable law and the directions stated in this document.
@line Signature: ________________________________________
@line Date: _____________________________________________
[[end]]
[[end]]
...
[[elif signing_state=INDIANA]]
// DRAFTER NOTE: Indiana uses a separate Funeral Planning Declaration executed with at least two qualified adult witnesses.

The following declaration is a separate legal instrument within this document.
...
[[elif signing_state=NEBRASKA]]
// DRAFTER NOTE: The Nebraska standalone right-of-disposition designation is made by affidavit before a notary public in substantially the statutory form. Attached lawful directions may be incorporated into that route.
@sub Notarial Acknowledgment
...
[[elif signing_state=SOUTH_DAKOTA]]
// DRAFTER NOTE: South Dakota requires the standalone designation affidavit to be executed before a notary public in substantially statutory form.
@sub Notarial Acknowledgment
...
[[elif signing_state=VIRGINIA]]
// DRAFTER NOTE: Virginia requires a signed and NOTARIZED writing for the standalone designee route, plus written acceptance by the designee.
@sub Notarial Acknowledgment
...
[[elif signing_state=WEST_VIRGINIA]]
// DRAFTER NOTE: West Virginia requires the standalone disposition-control affidavit to be executed before a notary public in substantially statutory form.
@sub Notarial Acknowledgment
