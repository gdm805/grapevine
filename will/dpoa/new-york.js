...
// ==========================================================================
//  GRAPEVINE  |  DURABLE POWER OF ATTORNEY  |  NEW YORK
//  Converted word for word from your file Grapevine_DPOA_New_York.docx (the controlled
...
@line Executed in ____________________ County, New York.
...
By signing as a witness, I acknowledge that the Principal signed the Power of Attorney in my presence and in the presence of the other witness, or acknowledged that the Principal's signature was affixed by the Principal or at the Principal's direction. I also acknowledge that the Principal stated that this Power of Attorney reflects the Principal's wishes and was signed voluntarily. I am not named in this instrument as an Agent or as a permissible recipient of gifts.
...
@sub IMPORTANT INFORMATION FOR THE AGENT
...
@sub AGENT'S SIGNATURE AND ACKNOWLEDGMENT OF APPOINTMENT
...
I, {{agent}}, have read the foregoing Power of Attorney. I am the person identified therein as agent for the principal named therein. I acknowledge my legal responsibilities.
...
On ____________________, before me, the undersigned, personally appeared {{agent}}, personally known to me or proved to me on the basis of satisfactory evidence to be the individual whose name is subscribed to this instrument and acknowledged to me that the individual executed the same.
