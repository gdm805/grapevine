...
// ==========================================================================
//  GRAPEVINE  |  DURABLE POWER OF ATTORNEY  |  CALIFORNIA
//  Converted word for word from your file Grapevine_DPOA_California.docx (the controlled
...
@sub Notice to Person Executing Durable Power of Attorney
...
@sub Notice to Person Accepting the Appointment as Attorney-in-Fact
...
@sign (Signature of agent)

@sign (Print name of agent)
...
For a springing Power of Attorney, the occurrence of my Incapacity shall be established by a written declaration under penalty of perjury made by the person or persons designated by me for that purpose. If no separate designee is identified, {{determiner}} is designated to make that determination. The declaration shall state that the specified incapacity event has occurred.
...
@line Executed in ____________________ County, California.
