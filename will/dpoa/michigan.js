...
window.DPOA_STATES["Michigan"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  DURABLE POWER OF ATTORNEY  |  MICHIGAN
//  Converted word for word from your file Grapevine_DPOA_Michigan.docx (the controlled
...
The extent of your agent’s authority over subjects listed on this form is explained in the uniform power of attorney act, MCL 556.201 to 556.505.
...
[[if foreign_financial_account_authority]]

My Agent may exercise authority over any bank, securities, or other financial account in a foreign country within the meaning of 31 CFR 1010.350.
...
@line Executed in ____________________ County, Michigan.
...
@sub AGENT'S ACKNOWLEDGMENT

I, {{agent}}, have been appointed agent for {{name}}, the principal, under a durable power of attorney dated ____________________, 20____. By signing this document, I acknowledge that if and when I act as agent under the power, all of the following apply:

@sub MY DUTIES AS AGENT
...
@sub POWERS REQUIRING SPECIFIC AUTHORITY
...
@sub TERMINATION OF MY AUTHORITY
...
@sub MY POTENTIAL LIABILITY AS AGENT

If I violate the uniform power of attorney act, MCL 556.201 to 556.505, or act outside the authority granted in the durable power, I may be liable to the principal or the principal’s successors for damages caused by my violation and to civil or criminal penalties.

An exoneration clause in the power (if any) does not relieve me of liability for acts or omissions committed in bad faith or, in some cases, for acts or omissions committed with reckless indifference to the purposes of the power of attorney or the interests of the principal.

@line DATED: ____________________
