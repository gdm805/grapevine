...
window.DPOA_STATES["Arkansas"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  DURABLE POWER OF ATTORNEY  |  ARKANSAS
//  Converted word for word from your file Grapevine_DPOA_Arkansas.docx (the controlled
...
If my Agent is my spouse, the filing or occurrence of divorce, dissolution, annulment, legal separation, or another relationship event affects the Agent's appointment or authority only as provided by applicable Arkansas law. Nothing in this Section preserves an appointment or authority that applicable law terminates or suspends.

# General Provisions and Definitions

## Governing Law; Validity; Severability

This Power of Attorney shall be governed and construed according to the law of Arkansas, except where another jurisdiction necessarily governs a particular transaction or property interest. I intend it to be recognized to the fullest extent permitted in other jurisdictions. If any provision or grant of authority is invalid or unenforceable, the remaining provisions shall continue to the fullest extent they can operate independently.
...
@line Executed in ____________________ County, Arkansas.
...
(5) cooperate with any person that has authority to make healthcare decisions for the principal to do what you know the principal reasonably expects or, if you do not know the principal's expectations, to act in the principal's best interest; and
