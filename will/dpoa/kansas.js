...
window.DPOA_STATES["Kansas"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  DURABLE POWER OF ATTORNEY  |  KANSAS
//  Converted word for word from your file Grapevine_DPOA_Kansas.docx (the controlled
...
This Power of Attorney is a durable power of attorney and the authority of my Agent shall not terminate if I become disabled or incapacitated or in the event of later uncertainty as to whether I am dead or alive.
...
Any authority to alienate my Kansas homestead is subject to the specific constitutional and statutory consent, property-description, and spousal-consent requirements applicable to the transaction.
...
@line Executed in ____________________ County, Kansas.
