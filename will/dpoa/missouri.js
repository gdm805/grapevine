...
window.DPOA_STATES["Missouri"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  DURABLE POWER OF ATTORNEY  |  MISSOURI
//  Converted word for word from your file Grapevine_DPOA_Missouri.docx (the controlled
...
This is a durable power of attorney. The authority granted to my Agent shall not terminate or be void or voidable if I become disabled, incapacitated, or in the event of later uncertainty as to whether I am dead or alive.
...
@line Executed in ____________________ County, Missouri.
