...
window.DPOA_STATES["Washington"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  DURABLE POWER OF ATTORNEY  |  WASHINGTON
//  Converted word for word from your file Grapevine_DPOA_Washington.docx (the controlled
...
Incapacity means inability to manage property or business affairs because I have an impairment in the ability to receive and evaluate information or make or communicate decisions even with technological assistance, or because I am an absentee or outside the United States and unable to return. If I have not designated another person to determine Incapacity, impairment-based Incapacity shall be determined in writing by a physician or licensed psychologist, unrelated to me or my Agent by blood or marriage, who has personally examined me; incapacity arising from absence or being outside the United States and unable to return shall be determined in writing by a judge or appropriate governmental official.
...
[[if power_of_appointment_to_others]]

My Agent may exercise a power of appointment in favor of a person other than me to the extent permitted by Washington law.

[[end]]

[[if community_property_agreement_authority]]

My Agent may create, amend, or revoke a community property agreement to the extent permitted by Washington law.

[[end]]

[[if trust_distribution_direction_authority]]

My Agent may cause a Trustee to make distributions of property held in trust under the same conditions that I could, to the extent permitted by Washington law.
...
@line Executed in ____________________ County, Washington.
