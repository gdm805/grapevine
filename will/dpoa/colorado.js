...
window.DPOA_STATES["Colorado"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  DURABLE POWER OF ATTORNEY  |  COLORADO
//  Converted word for word from your file Grapevine_DPOA_Colorado.docx (the controlled
...
If my Agent is my spouse, the filing or occurrence of divorce, dissolution, annulment, legal separation, or another relationship event affects the Agent's appointment or authority only as provided by applicable Colorado law. Nothing in this Section preserves an appointment or authority that applicable law terminates or suspends.

# General Provisions and Definitions

## Governing Law; Validity; Severability

This Power of Attorney shall be governed and construed according to the law of Colorado, except where another jurisdiction necessarily governs a particular transaction or property interest. I intend it to be recognized to the fullest extent permitted in other jurisdictions. If any provision or grant of authority is invalid or unenforceable, the remaining provisions shall continue to the fullest extent they can operate independently.
...
@line Executed in ____________________ County, Colorado.
