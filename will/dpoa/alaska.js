...
// ==========================================================================
//  GRAPEVINE  |  DURABLE POWER OF ATTORNEY  |  ALASKA
//  Converted word for word from your file Grapevine_DPOA_Alaska.docx (the controlled
...
For purposes of determining when my Agent's authority becomes effective, Incapacity is established by an affidavit stating that I am unable to manage my property or business affairs because I have an impairment in the ability to receive and evaluate information or make or communicate decisions, even with technological assistance, resulting from a medical, physical, mental, psychological, age-related, substance-related, or similar condition to such an extent that I am unable to manage my property or affairs; or because I am missing, detained (including incarcerated), or outside the United States and unable to return.

If the affidavit is based on impairment, it shall be signed by two physicians or similarly qualified medical professionals who have personally examined me. If only one such professional is available, the affidavit may be signed by that professional if the affidavit states that only one physician or similarly qualified medical professional is available.
...
@line ____________________ JUDICIAL DISTRICT
