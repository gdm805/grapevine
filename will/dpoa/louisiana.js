...
window.DPOA_STATES["Louisiana"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  DURABLE POWER OF ATTORNEY  |  LOUISIANA
//  Converted word for word from your file Grapevine_DPOA_Louisiana.docx (the controlled
...
@line Executed in ____________________ Parish, Louisiana.
...
This instrument was executed before me, a notary public or other officer authorized to perform that function, in the presence of the two witnesses whose signatures appear above, by {{name}} on ____________________.
