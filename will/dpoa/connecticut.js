...
window.DPOA_STATES["Connecticut"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  DURABLE POWER OF ATTORNEY  |  CONNECTICUT
//  Converted word for word from your file Grapevine_DPOA_Connecticut.docx (the controlled
...
The powers granted by this document are broad and sweeping. They are defined in the Connecticut Uniform Power of Attorney Act, which expressly permits the use of any other or different form of power of attorney desired by the parties concerned. The grantor of any power of attorney, the agent or such other person or entities as authorized by statute may make application to a Probate Court for an accounting as provided in subsection (d) of section 45a-175 of the general statutes.
...
If my Agent is my spouse, the filing or occurrence of divorce, dissolution, annulment, legal separation, or another relationship event affects the Agent's appointment or authority only as provided by applicable Connecticut law. Nothing in this Section preserves an appointment or authority that applicable law terminates or suspends.

# General Provisions and Definitions

## Governing Law; Validity; Severability

This Power of Attorney shall be governed and construed according to the law of Connecticut, except where another jurisdiction necessarily governs a particular transaction or property interest. I intend it to be recognized to the fullest extent permitted in other jurisdictions. If any provision or grant of authority is invalid or unenforceable, the remaining provisions shall continue to the fullest extent they can operate independently.
...
@line Executed in ____________________ County, Connecticut.
...
The Principal signed or acknowledged this Power of Attorney in our conscious physical presence, and we sign as witnesses.
...
@line Witness 2: ____________________________________
...
@sign Notary Public / Commissioner of the Superior Court / Authorized Officer

@sub IMPORTANT INFORMATION FOR AGENT

@sub Agent's Duties

When you accept the authority granted under this power of attorney, a special legal relationship is created between you and the principal. This relationship continues until you resign or the power of attorney is terminated or revoked.
