...
window.DPOA_STATES["Texas"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  DURABLE POWER OF ATTORNEY  |  TEXAS
//  Converted word for word from your file Grapevine_DPOA_Texas.docx (the controlled
...
For purposes of a springing Power of Attorney, unless otherwise defined in this instrument, I am disabled or incapacitated if a physician certifies in writing at a date later than the date this Power of Attorney is executed that, based on the physician’s medical examination of me, I am mentally incapable of managing my financial affairs.
...
@line Executed in ____________________ County, Texas.
...
@item (A) the property belonging to the principal that has come to your knowledge or into your possession;

@item (B) each action taken or decision made by you as agent;

@item (C) a complete account of receipts, disbursements, and other actions of you as agent that includes the source and nature of each receipt, disbursement, or action, with receipts of principal and income shown separately;

@item (D) a listing of all property over which you have exercised control that includes an adequate description of each asset and the asset's current value, if known to you;

@item (E) the cash balance on hand and the name and location of the depository at which the cash balance is kept;

@item (F) each known liability;

@item (G) any other information and facts known to you as necessary for a full and definite understanding of the exact condition of the property belonging to the principal; and

@item (H) all documentation regarding the principal's property.
