...
window.DPOA_STATES["Delaware"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  DURABLE POWER OF ATTORNEY  |  DELAWARE
//  Converted word for word from your file Grapevine_DPOA_Delaware.docx (the controlled
...
@sub DURABLE PERSONAL POWER OF ATTORNEY FORM NOTICE
...
A person appointed as Agent is not required to serve. Before exercising authority, the Agent must execute and affix the Agent Certification included with this Power of Attorney as required by Delaware law. A vacancy shall be filled by the next willing and eligible successor Agent designated by me.
...
If this Power of Attorney is selected to become effective upon my Incapacity and no person designated by me is able and willing to determine Incapacity, my Incapacity shall be established by a determination in a writing or other record by a physician, the Delaware Court of Chancery, or another court of competent jurisdiction that I am incapacitated.
...
@line Executed in ____________________ County, Delaware.

@line DATED: ____________________, 20____

@sign {{name}}, Principal

@sub Qualified Witness

I witnessed the Principal sign this Power of Attorney. I am an adult, am not related to the Principal by blood, marriage, or adoption, and am not entitled to any portion of the Principal's estate under the Principal's existing will, codicil, trust, or amendment.
...
@sign (Principal’s Name) by (Your Signature) as Agent
...
@sub AGENT’S CERTIFICATION

I, {{agent}}, have read the attached durable personal power of attorney and I am the person identified as the Agent or identified as the Agent for the Principal. To the best of my knowledge this power has not been revoked. I hereby acknowledge that, when I act as Agent, I shall:
