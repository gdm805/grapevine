...
window.DPOA_STATES["Florida"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  DURABLE POWER OF ATTORNEY  |  FLORIDA
//  Converted word for word from your file Grapevine_DPOA_Florida.docx (the controlled
...
This Power of Attorney is effective when I execute it. Florida law does not permit an ordinary durable power of attorney executed under the current statute to become effective only upon a future incapacity or other future contingency.
...
Principal signature or initials for this authority: ____________________
...
The following trust powers are granted only when separately selected and signed or initialed below, and only to the extent the governing trust instrument expressly permits exercise of the particular power by the settlor's Agent and Florida law permits the exercise.
...
If my Agent is my spouse, the Agent's authority terminates when an action is filed for dissolution or annulment of marriage, or for legal separation, unless this Power of Attorney otherwise provides, subject to Florida law.

# General Provisions and Definitions

## Governing Law; Validity; Severability

This Power of Attorney shall be governed and construed according to the law of Florida, except where another jurisdiction necessarily governs a particular transaction or property interest. I intend it to be recognized to the fullest extent permitted in other jurisdictions. If any provision or grant of authority is invalid or unenforceable, the remaining provisions shall continue to the fullest extent they can operate independently.
...
@line Executed in ____________________ County, Florida.
...
Signed by the Principal in our presence as subscribing witnesses.
...
The foregoing instrument was acknowledged before me by means authorized by Florida law by {{name}} on ____________________.
