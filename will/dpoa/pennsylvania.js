...
window.DPOA_STATES["Pennsylvania"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  DURABLE POWER OF ATTORNEY  |  PENNSYLVANIA
//  Converted word for word from your file Grapevine_DPOA_Pennsylvania.docx (the controlled
...
@line Executed in ____________________ County, Pennsylvania.
...
@sub ACKNOWLEDGMENT EXECUTED BY AGENT

I, {{agent}}, have read the attached power of attorney and am the person identified as the agent for the principal. I hereby acknowledge that when I act as agent:
