...
window.DPOA_STATES["Georgia"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  DURABLE POWER OF ATTORNEY  |  GEORGIA
//  Converted word for word from your file Grapevine_DPOA_Georgia.docx (the controlled
...
A person appointed as Agent is not required to serve and accepts appointment by exercising authority or performing duties as Agent, or by other conduct indicating acceptance, to the extent provided by applicable law. An Agent may resign by written notice as permitted by applicable law. A vacancy shall be filled by the next willing and eligible successor Agent designated by me.
...
If this Power of Attorney is selected to become effective upon my Incapacity and no person designated by me is able and willing to determine Incapacity, Incapacity resulting from an impairment in my ability to receive and evaluate information or make or communicate decisions shall be established in a writing or other record by a physician or licensed psychologist. Incapacity resulting from my being missing, detained (including incarceration), or outside the United States and unable to return shall be established in a writing or other record by an attorney at law, a judge, or an appropriate governmental official, to the extent provided by applicable state law.
...
Each power described in this Article may be granted, withheld, or limited separately. The grant of one special power does not imply another, and no general provision elsewhere in this Power of Attorney shall be construed to grant a power for which applicable law requires express authority. Georgia also requires an express grant for authority over the content of electronic communications and for renouncing an interest in property; those grants appear expressly in this document when selected.
...
If my Agent is my spouse, the filing or occurrence of divorce, dissolution, annulment, legal separation, or another relationship event affects the Agent's appointment or authority only as provided by applicable Georgia law. Nothing in this Section preserves an appointment or authority that applicable law terminates or suspends.

# General Provisions and Definitions

## Governing Law; Validity; Severability

This Power of Attorney shall be governed and construed according to the law of Georgia, except where another jurisdiction necessarily governs a particular transaction or property interest. I intend it to be recognized to the fullest extent permitted in other jurisdictions. If any provision or grant of authority is invalid or unenforceable, the remaining provisions shall continue to the fullest extent they can operate independently.
...
@line Executed in ____________________ County, Georgia.
...
Signed by the Principal in our presence. The first signer below is a competent witness who is not named as Agent. The second attesting officer is a person authorized under Georgia law to attest the execution and is not the same person as the first witness and is not named as Agent.

@line Witness: ____________________________________

@line Date: ____________________

@line Printed Name: __________________________________

@line Attesting Officer / Notary: ________________________________

@line Date: ____________________

@line Printed Name and Title: _________________________________

Notarial seal, if applicable
