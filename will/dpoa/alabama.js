...
window.DPOA_STATES["Alabama"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  DURABLE POWER OF ATTORNEY  |  ALABAMA
//  Converted word for word from your file Grapevine_DPOA_Alabama.docx (the controlled
...
This Durable Power of Attorney authorizes another person, called the Agent, to make decisions and act concerning your property and financial affairs. The Agent may exercise only the authority granted by this document and permitted by Alabama law.

This Durable Power of Attorney does not authorize the Agent to make health care decisions for you. Health care decisions are governed by separate applicable law and any health care directive or other health care authorization you may have made.

You should select someone you trust to serve as Agent. Unless this Durable Power of Attorney provides otherwise, the Agent's authority continues until you die, revoke the Power of Attorney, or the Agent resigns, becomes unable to act, or the Agent's authority otherwise terminates under Alabama law.

Your Agent is entitled to reimbursement of reasonable expenses and to reasonable compensation to the extent provided in this Durable Power of Attorney and permitted by Alabama law.

If your first Agent cannot or will not serve, a successor Agent named in this Durable Power of Attorney may serve in the order designated.

This Durable Power of Attorney becomes effective as provided in Article Three. If immediate effectiveness is selected, the Agent may act when you execute this document. If effectiveness upon Incapacity is selected, the Agent may act only after Incapacity is established as provided in Article Three.

Granting authority over gifts, trusts, beneficiary designations, survivorship rights, delegation, survivor benefits, or other estate-planning matters can significantly affect your property and estate plan. Those powers are granted only when expressly included in this Durable Power of Attorney.

If you do not understand this Durable Power of Attorney or the authority you are granting, you should obtain legal advice before signing it.
...
A person appointed as Agent is not required to serve. Unless this Power of Attorney provides otherwise, a person accepts appointment as Agent by exercising authority or performing duties as Agent, or by other conduct indicating acceptance. An Agent may resign by written notice to me while I have capacity or, if I am incapacitated, as permitted by Alabama law. A vacancy shall be filled by the next willing and eligible successor Agent designated by me.
...
For purposes of a Power of Attorney that becomes effective upon my Incapacity, "Incapacity" means my inability to manage my property or business affairs because I either (a) have an impairment in the ability to receive and evaluate information or to make or communicate decisions, even with the use of technological assistance, or (b) am missing, detained (including incarceration), or outside the United States and unable to return.

@item If I have not separately authorized a person to determine whether I am incapacitated, or that person is unable or unwilling to make the determination, Incapacity based on impairment shall be established by a determination in a writing or other record by a physician or licensed psychologist. Incapacity based on my being missing, detained, or outside the United States and unable to return shall be established by a determination in a writing or other record by an attorney-at-law, a judge, or an appropriate governmental official.

@item A person whom I expressly authorize in this Power of Attorney to determine my Incapacity may obtain and communicate with my health care providers concerning information reasonably necessary to make that determination to the extent permitted by applicable law.
...
If my Agent's authority became effective solely because of my Incapacity, that authority shall cease while I have regained capacity. Restoration of capacity shall be established in a writing or other record by the person I authorized to determine Incapacity or, if no such person is authorized and available, by a physician or licensed psychologist with respect to an impairment-based Incapacity. This cessation of springing authority does not revoke this Power of Attorney, which may again become effective upon a later determination of Incapacity under this Article.
...
My Agent may make gifts to persons or organizations to the extent permitted by Alabama law. Unless this Power of Attorney expressly grants broader gifting authority, this authority is subject to the limits and standards applicable to general gifting authority under Alabama law, including applicable per-donee limits and the requirement that gifts be consistent with my known objectives or, if unknown, my best interest. No gift to or for the benefit of my Agent is authorized unless separately selected below.
...
@item My Agent may terminate an inter vivos trust to the extent I possess and may lawfully delegate that authority.
...
If my Agent is my spouse, that Agent's authority terminates upon the filing of an action for divorce or annulment of our marriage or for our legal separation, unless this Power of Attorney expressly provides otherwise. Termination of my spouse's authority does not terminate this Power of Attorney if a successor Agent is available to serve.

# General Provisions and Definitions

## Governing Law; Validity; Severability

This Power of Attorney shall be governed and construed according to the law of Alabama, except where another jurisdiction necessarily governs a particular transaction or property interest. I intend it to be recognized to the fullest extent permitted in other jurisdictions. If any provision or grant of authority is invalid or unenforceable, the remaining provisions shall continue to the fullest extent they can operate independently.
...
@center [EXECUTION FOLLOWS ON NEXT PAGE]

[[pagebreak]]

# Execution

## Declaration and Execution of Principal
...
@line Executed in ____________________ County, Alabama.
...
@line ____________________ COUNTY

I, the undersigned notarial officer, certify that {{name}}, whose name is signed to the foregoing instrument and who is known to me or satisfactorily identified, acknowledged before me that, being informed of the contents of the instrument, the Principal executed it voluntarily.

@line Acknowledged before me on ______________________, 20____.
...
When you accept authority under this Durable Power of Attorney, you enter into a legal relationship with the Principal and assume duties under Alabama law. You must act only within the authority granted by this document and must stop acting when you know that this Power of Attorney or your authority has terminated.

You must act in accordance with the Principal's reasonable expectations to the extent actually known and otherwise in the Principal's best interest; act in good faith; and act only within the scope of authority granted. Unless this Durable Power of Attorney provides otherwise, Alabama law also requires loyalty, avoidance of disabling conflicts of interest, care, competence, diligence, appropriate recordkeeping, cooperation with persons authorized to make health care decisions for the Principal, and reasonable efforts to preserve the Principal's estate plan when known and consistent with the Principal's best interest.

When acting for the Principal, you should disclose that you are acting as Agent. Authority under this Durable Power of Attorney does not authorize conduct prohibited by law or conduct outside the powers expressly granted.

Your authority may terminate because of the Principal's death or revocation, your resignation or other termination of authority, an event stated in this Durable Power of Attorney, completion of its purpose, or another event provided by Alabama law. If you are the Principal's spouse, your authority is also subject to the marriage and divorce provisions of this Durable Power of Attorney and Alabama law.

An Agent who violates the Alabama Uniform Power of Attorney Act or acts outside the authority granted by this Durable Power of Attorney may be liable for resulting damages. If you do not understand this document, your authority, or your duties, you should obtain legal advice.
`;
