...
window.HCD_STATES["Vermont"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  VERMONT
//  Converted word for word from your file Grapevine_HCD_Vermont.docx (the controlled
...
@set ask_vt_facility_explanation = yes
@set has_witness = yes
@set has_notary = no
...
Section 13.10 — Vermont Facility Explanation

[[if vt_facility_explanation]]

Before execution, the nature and effect of this Advance Directive shall be explained to the Principal by the individual authorized by Vermont law, and the required affirmation shall be completed with the execution package.
...
The Principal executes this Advance Directive for Health Care voluntarily.
...
We affirm that the Principal appeared to understand the nature of this document and to be free from duress or undue influence at the time the Advance Directive was signed.
...
@sub FACILITY EXPLANATION / AFFIRMATION

I affirm that I explained the nature and effect of this Advance Directive to the Principal as required by Vermont law.

@line Authorized Explainer Signature: ____________________

@line Date: __________

@line Print Name / Role: ______________________________
