...
window.HCD_STATES["Ohio"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  OHIO
//  Converted word for word from your file Grapevine_HCD_Ohio.docx (the controlled
...
@set ask_oh_unconscious_anh = yes
@set ask_sc_optional_notary = no
@set ask_vt_facility_explanation = no
@set has_witness = yes
@set has_notary = yes

@center **DURABLE POWER OF ATTORNEY FOR HEALTH CARE AND LIVING WILL**
...
Section 7.06 — Ohio Artificial Nutrition and Hydration Authorization

[[if oh_unconscious_anh=YES]]

THE PRINCIPAL EXPRESSLY AUTHORIZES THE ATTORNEY IN FACT TO CONSENT TO THE WITHHOLDING OR WITHDRAWAL OF ARTIFICIALLY OR TECHNOLOGICALLY SUPPLIED NUTRITION OR HYDRATION IF THE CONDITIONS REQUIRED BY OHIO LAW ARE SATISFIED.
Principal Initials: __________
...
The Principal executes this Durable Power of Attorney for Health Care and Living Will voluntarily.
...
By signing below, each witness attests to the witness’s belief that the Principal appears to be of sound mind and not under or subject to duress, fraud, or undue influence. Each witness is an adult and is eligible to serve under Ohio law.
...
@line The foregoing instrument was acknowledged before me by {{name}} on __________. I further attest that the Principal appears to be of sound mind and not under or subject to duress, fraud, or undue influence.
