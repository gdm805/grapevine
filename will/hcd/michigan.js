...
window.HCD_STATES["Michigan"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  MICHIGAN
//  Converted word for word from your file Grapevine_HCD_Michigan.docx (the controlled
...
This Directive is intended to constitute a Patient Advocate Designation under MCL 700.5506 through 700.5515.
...
The Patient Advocate's authority concerning medical or mental health treatment becomes exercisable only when the Principal is unable to participate in those decisions as determined in the manner required by Michigan law.
...
## Michigan Express End-of-Life Authorization

The Principal expressly authorizes the Patient Advocate to make a decision to withhold or withdraw treatment that could or would allow the Principal to die when that decision is consistent with the Principal's controlling instructions and Michigan law. The Principal acknowledges that such a decision could or would allow the Principal's death.
...
We witnessed the Principal execute this Patient Advocate Designation. The Principal appeared to be of sound mind and under no duress, fraud, or undue influence. Each witness confirms that the witness is qualified under MCL 700.5506 and is not a disqualified person listed there.
...
@sub PATIENT ADVOCATE ACCEPTANCE
...
5. A patient advocate shall not receive compensation for the performance of the patient advocate's authority, rights, and responsibilities, but may be reimbursed for actual and necessary expenses incurred in the performance of those authority, rights, and responsibilities.
...
I accept appointment as Patient Advocate and acknowledge the foregoing statements.

@line Patient Advocate Signature: ______________________________
...
@line Successor Patient Advocate Signature: ____________________

@line Printed Name: {{successor}}
