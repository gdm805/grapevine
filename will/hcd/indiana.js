...
window.HCD_STATES["Indiana"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  INDIANA
//  Converted word for word from your file Grapevine_HCD_Indiana.docx (the controlled
...
@center **HEALTH CARE ADVANCE DIRECTIVE**
...
This Directive is intended to constitute an advance directive under Indiana Code Title 16, Article 36, Chapter 7.
...
This Directive expressly delays the Health Care Representative's health-care decision authority until the Principal lacks capacity to make the decision at issue. The Principal retains authority while capable, notwithstanding Indiana’s statutory presumption of immediate effectiveness when a directive does not state a delayed trigger.
...
We are adults and witnessed the Principal sign or acknowledge this Advance Directive in the manner permitted by Indiana law. At least one of us is not the Principal’s spouse or other relative.
...
@line Before me, the undersigned, a Notary Public in and for said County and State, personally appeared {{name}}, and acknowledged the execution of the foregoing instrument this ______ day of __________________, 20______.
...
@line Title of Office: Notary Public

@line Indiana County of Commission/Employment: ______________________________
