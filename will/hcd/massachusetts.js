...
window.HCD_STATES["Massachusetts"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  MASSACHUSETTS
//  Converted word for word from your file Grapevine_HCD_Massachusetts.docx (the controlled
...
@center **HEALTH CARE PROXY WITH HEALTH CARE INSTRUCTIONS**
...
This Directive is intended to constitute a Health Care Proxy under Massachusetts General Laws chapter 201D. The treatment provisions are instructions and evidence of the Principal's wishes for use by the Health Care Agent.
...
The Health Care Agent's decision-making authority becomes effective when the attending physician determines in writing that the Principal lacks the capacity to make or communicate health care decisions, as provided by Massachusetts General Laws chapter 201D.
...
@sub WITNESS AFFIRMATION

We affirm that the Principal appeared to be at least eighteen years of age, of sound mind, and under no constraint or undue influence when the Principal signed this Health Care Proxy. Neither witness is the person named as Health Care Agent.
