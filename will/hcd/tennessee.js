...
window.HCD_STATES["Tennessee"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  TENNESSEE
//  Converted word for word from your file Grapevine_HCD_Tennessee.docx (the controlled
...
This form replaces the old forms for durable power of attorney for health care, living will, appointment of agent, and advance care plan, and eliminates the need for any of those documents.
...
1. I am a competent adult who is not named as the agent. I witnessed the patient’s signature on this form.

@line Witness 1 Signature: ______________________________

2. I am a competent adult who is not named as the agent. I am not related to the patient by blood, marriage, or adoption and I would not be entitled to any portion of the patient’s estate upon death under any existing will or codicil or by operation of law. I witnessed the patient’s signature on this form.

@line Witness 2 Signature: ______________________________
