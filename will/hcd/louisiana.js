...
window.HCD_STATES["Louisiana"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  LOUISIANA
//  Converted word for word from your file Grapevine_HCD_Louisiana.docx (the controlled
...
This Directive is intended to create a health care mandate under Louisiana Civil Code articles 2989 and 2997 and a declaration concerning life-sustaining procedures under La. R.S. 40:1151 et seq.
...
The Principal expressly authorizes the Health Care Agent, as mandatary, to make health care decisions for the Principal, including surgery, medical expenses, nursing home residency, medication, and other health care decisions within the scope of this Directive, as contemplated by Louisiana Civil Code article 2997(6).
...
If the Principal has been diagnosed as having a terminal and irreversible condition and is unable to communicate health care decisions, the Principal's treatment election below applies to life-sustaining procedures under La. R.S. 40:1151 et seq.
...
@sub WITNESS DECLARATION

The declarant has been personally known to me and I believe the declarant to be of sound mind.
...
Each witness must be a competent adult who is not related to the Principal by blood or marriage and who would not be entitled to any portion of the Principal's estate upon death.
`;
