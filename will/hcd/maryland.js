...
window.HCD_STATES["Maryland"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  MARYLAND
//  Converted word for word from your file Grapevine_HCD_Maryland.docx (the controlled
...
This Directive is intended to constitute an advance directive under Maryland Health-General Article, Title 5, Subtitle 6.
...
@line Telephone Number(s): ___________________________________
...
Anyone selected as a health care agent may not be a witness. At least one witness must be someone who will not knowingly inherit anything from the Principal or otherwise knowingly gain a financial benefit from the Principal's death.
`;
