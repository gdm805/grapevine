...
window.HCD_STATES["California"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  CALIFORNIA
//  Converted word for word from your file Grapevine_HCD_California.docx (the controlled
...
@set ask_ca_skilled_nursing = yes
@set ask_ct_dmhas = no
@set ask_ct_dds = no
...
(Your agent may not be an operator or employee of a community care facility or a residential care facility where you are receiving care, or your supervising health care provider or employee of the health care institution where you are receiving care, unless your agent is related to you or is a coworker.)
...
If you are satisfied to allow your agent to determine what is best for you in making end-of-life decisions, you need not fill out Part 2 of this form.
...
You should talk to the person you have named as agent to make sure that they understand your wishes and is willing to take the responsibility.
...
This Directive is intended to constitute an Advance Health Care Directive under California Probate Code §§ 4670 et seq.
...
Unless otherwise specified in this Directive, a determination that the Principal lacks or has recovered capacity shall be made by the Principal’s primary physician as provided by California law.
...
[[if ca_skilled_nursing]]

## Skilled Nursing Facility Execution Requirement

If the Principal is a patient in a skilled nursing facility when this Directive is executed, the additional patient advocate or ombudsman witness requirement imposed by California Probate Code § 4701 and related law must be satisfied in addition to the otherwise selected execution route.
...
The Principal declares that the Principal understands the nature and purpose of this Directive and executes it voluntarily with the intent that it be effective according to its terms and California law.
...
@line First Witness Signature: _________________________________
...
@line Second Witness Signature: ________________________________
...
@sub ADDITIONAL STATEMENT OF WITNESSES

At least one of the above witnesses must also sign the following declaration:

I further declare under penalty of perjury under the laws of California that I am not related to the individual executing this advance health care directive by blood, marriage, or adoption, and, to the best of my knowledge, I am not entitled to any part of the individual’s estate upon the individual’s death under a will now existing or by operation of law.

@line Signature of Qualifying Witness: ___________________________

@line Date: __________________

[[elif exec_route=NOTARY]]

@sub CERTIFICATE OF ACKNOWLEDGMENT OF NOTARY PUBLIC

@line State of California

@line County of {{county}}

@line On __________________ before me, ______________________________________________, personally appeared {{name}}, who proved to me on the basis of satisfactory evidence to be the person(s) whose name(s) is/are subscribed to the within instrument and acknowledged to me that he/she/they executed the same in his/her/their authorized capacity(ies), and that by his/her/their signature(s) on the instrument the person(s), or the entity upon behalf of which the person(s) acted, executed the instrument.
...
@sub STATEMENT OF PATIENT ADVOCATE OR OMBUDSMAN
...
@line Signature: __________________________________
