...
window.HCD_STATES["South Carolina"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  SOUTH CAROLINA
//  Converted word for word from your file Grapevine_HCD_South_Carolina.docx (the controlled
...
@set ask_sc_optional_notary = yes
...
The Principal executes this Health Care Power of Attorney voluntarily.
...
@line The foregoing instrument was acknowledged before me by {{name}} on _______________, 20 _________.

@line Notary Public for South Carolina: ______________________________

@line My Commission Expires: ______________________
