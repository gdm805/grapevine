...
window.HCD_STATES["Kansas"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  KANSAS
//  Converted word for word from your file Grapevine_HCD_Kansas.docx (the controlled
...
This Directive is intended to constitute a durable power of attorney for health care decisions under K.S.A. 58-625 through 58-632, together with the Principal's health care instructions.
...
Except for authority expressly made effective earlier in this Directive, the Agent's authority becomes effective upon the Principal's impairment as determined by the Principal's attending physician under Kansas law.
...
The Health Care Agent has no authority to revoke or invalidate a previously existing declaration under the Kansas Natural Death Act merely by reason of the agency created by this Directive.
