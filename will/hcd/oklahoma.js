...
window.HCD_STATES["Oklahoma"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  OKLAHOMA
//  Converted word for word from your file Grapevine_HCD_Oklahoma.docx (the controlled
...
The Principal executes this Health Care Power of Attorney and Advance Directive voluntarily.
...
The Principal signed or acknowledged this Directive in our presence. We are adults and are qualified to serve as witnesses under Oklahoma law.
...
This two-witness execution is intended to satisfy the current Oklahoma Advance Directive Act component through June 30, 2027.
`;
