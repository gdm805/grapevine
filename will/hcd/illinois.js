...
window.HCD_STATES["Illinois"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  ILLINOIS
//  Converted word for word from your file Grapevine_HCD_Illinois.docx (the controlled
...
This Directive is intended to create a health care agency under the Illinois Power of Attorney Act, 755 ILCS 45/4-1 et seq., and to state the Principal’s health care instructions.
...
The Principal declares that the Principal understands the nature and purpose of this nonstatutory Illinois Power of Attorney for Health Care and health-care instruction document and executes it voluntarily.
