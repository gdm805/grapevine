...
window.HCD_STATES["Arkansas"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  ARKANSAS
//  Converted word for word from your file Grapevine_HCD_Arkansas.docx (the controlled
...
Competent adults and emancipated minors may give advance instructions using this form or any form of their own choosing. To be legally binding, the Advance Care Plan must be signed and either witnessed or notarized.
...
This Directive is intended to constitute an advance health care directive under the Arkansas Healthcare Decisions Act and applicable Arkansas law.
...
The Directive above was signed or acknowledged in our presence by {{name}} as the Principal’s advance directive. We attest that we comply with Ark. Code Ann. § 20-6-103(c): each of us is a competent adult and is not the named Agent, and at least one of us is not related to the Principal by blood, marriage, or adoption and would not be entitled to any portion of the Principal’s estate upon the Principal’s death under any existing will or codicil or by operation of law.
...
@line On this the ______ day of __________________, 20____, before me, ______________________________________, the undersigned notary, personally appeared {{name}}, known to me (or satisfactorily proven) to be the person whose name is subscribed to the within instrument and acknowledged that he/she/they executed the same for the purposes therein contained.
