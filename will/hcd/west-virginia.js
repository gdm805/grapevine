...
window.HCD_STATES["West Virginia"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  WEST VIRGINIA
//  Converted word for word from your file Grapevine_HCD_West_Virginia.docx (the controlled
...
Section 13.10 — West Virginia Directive Priority

A legally effective written directive of the Principal controls over a conflicting decision of an agent or surrogate to the extent required by West Virginia law. If two written directives conflict, priority shall be determined under West Virginia law.

Execution follows on the next page.

#! EXECUTION

The Principal executes this Combined Medical Power of Attorney and Living Will voluntarily.

@sub PRINCIPAL

@line Signature of Principal: ______________________________

@line Date: ____________________, 20____

@line Address of Principal: ______________________________

@sub WITNESSES

I did not sign the Principal’s signature above. I am at least 18 years of age and am not related to the Principal by blood or marriage. I am not entitled to any portion of the estate of the Principal or, to the best of my knowledge, under any will or codicil, nor legally responsible for the costs of the Principal’s medical or other care. I am not the Principal’s attending physician, nor am I the representative or successor representative of the Principal.
...
@line I, ______________________________, a Notary Public of said county, do certify that {{name}}, as Principal, and ____________________ and ____________________, as witnesses, whose names are signed to the writing above bearing date on the _____ day of ______________, 20___, have this day acknowledged the same before me.

@line Given under my hand this _____ day of _________________, 20___.
