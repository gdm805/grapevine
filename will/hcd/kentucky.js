...
window.HCD_STATES["Kentucky"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  KENTUCKY
//  Converted word for word from your file Grapevine_HCD_Kentucky.docx (the controlled
...
This Directive is intended to constitute an advance directive under KRS 311.621 through 311.643, including the designation of a health care surrogate and the Principal's treatment instructions.
...
@line ________________ County

Before me, the undersigned authority, came the grantor who is of sound mind and eighteen (18) years of age, or older, and acknowledged that the grantor voluntarily dated and signed this writing or directed it to be signed and dated as above.

@line Done this ____ day of __________________, 20____.

@line Signature of Notary Public or other officer: ______________________________

@line Date commission expires: ______________________________
