...
window.HCD_STATES["Alabama"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  ALABAMA
//  Converted word for word from your file Grapevine_HCD_Alabama.docx (the controlled
...
This Directive is intended to constitute an Advance Directive for Health Care under Ala. Code § 22-8A-4, including a Living Will and Health Care Proxy designation.
...
The Principal specifically authorizes the withholding or withdrawal of artificially provided nutrition under the circumstances stated in Article Six.
...
The Principal specifically authorizes the withholding or withdrawal of artificially provided hydration under the circumstances stated in Article Six.
...
## Alabama Pregnancy Limitation

If the Principal is known by the attending physician to be pregnant, this Advance Directive has no effect during the course of the pregnancy as provided by Ala. Code § 22-8A-4(e).

## Proxy and Living Will Priority

If both the Living Will and Health Care Proxy designation apply, the Health Care Proxy’s decisions concerning life-sustaining treatment or artificially provided nutrition or hydration control unless this Directive expressly provides otherwise, consistent with Ala. Code § 22-8A-4(g).
...
@line Name of First Witness: ___________________________________

@line Signature: ______________________________________________

@line Date: __________________

@line Name of Second Witness: __________________________________

@line Signature: ______________________________________________

@line Date: __________________

@sub ACCEPTANCE OF HEALTH CARE PROXY

I, {{agent}}, am willing to serve as the health care proxy.
...
I, {{successor}}, am willing to serve as the health care proxy if the prior choice cannot serve.
