...
window.HCD_STATES["Pennsylvania"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  PENNSYLVANIA
//  Converted word for word from your file Grapevine_HCD_Pennsylvania.docx (the controlled
...
@center **DURABLE HEALTH CARE POWER OF ATTORNEY AND LIVING WILL**

**INTRODUCTORY REMARKS ON HEALTH CARE DECISION MAKING**

You have the right to decide the type of health care you want.

Should you become unable to understand, make or communicate decisions about medical care, your wishes for medical treatment are most likely to be followed if you express those wishes in advance by naming a health care agent to decide treatment for you and by giving health care treatment instructions to your health care agent or health care provider.

An advance health care directive is a written set of instructions expressing your wishes for medical treatment.
...
Having carefully read this document, the Principal signs it voluntarily.
...
Two witnesses at least 18 years of age are required by Pennsylvania law. A person who signs this document on behalf of and at the direction of the Principal may not be a witness.
