...
window.HCD_STATES["Wisconsin"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  WISCONSIN
//  Converted word for word from your file Grapevine_HCD_Wisconsin.docx (the controlled
...
@center **POWER OF ATTORNEY FOR HEALTH CARE**
...
Section 4.05 — Wisconsin Statutory Limitations

The Health Care Agent may not exercise authority prohibited by Wisconsin law, including authority concerning certain inpatient mental-health placements or treatment procedures. Authority concerning admission to a nursing home or community-based residential facility and authority to withhold or withdraw a feeding tube shall be effective only to the extent expressly selected by the Principal in the applicable Grapevine election.

Execution follows on the next page.

#! EXECUTION

The Principal executes this Power of Attorney for Health Care voluntarily.
...
@line Witness 1: Print Name ____________________  Address ____________________

@line Signature: ______________________________

@line Date: __________

@line Witness 2: Print Name ____________________  Address ____________________

@line Signature: ______________________________

@line Date: __________

@sub STATEMENT OF HEALTH CARE AGENT

I understand that {{name}} has designated me to be his or her health care agent or alternate health care agent if he or she is ever found to have incapacity and unable to make health care decisions himself or herself. {{name}} has discussed his or her desires regarding health care decisions with me.

@line Agent Signature: ______________________________
...
@line Alternate Agent Signature: ______________________________
