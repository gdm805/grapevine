...
window.HCD_STATES["Idaho"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  IDAHO
//  Converted word for word from your file Grapevine_HCD_Idaho.docx (the controlled
...
This Directive is intended to constitute an Advance Care Planning Document under Idaho Code § 39-4510 and the Medical Consent and Natural Death Act.
