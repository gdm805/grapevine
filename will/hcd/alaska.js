...
window.HCD_STATES["Alaska"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  ALASKA
//  Converted word for word from your file Grapevine_HCD_Alaska.docx (the controlled
...
This Directive is intended to constitute an advance health care directive under Alaska Stat. § 13.52.010 et seq.
...
Unless this Directive provides another lawful method, the determination that the Principal lacks or has recovered capacity shall be made in the manner provided by Alaska law.
...
@sub WITNESS WHO IS NOT RELATED TO OR A DEVISEE OF THE PRINCIPAL
...
@line Signature of Witness: _________________________________
...
I swear under penalty of perjury under AS 11.56.200 that the principal is personally known to me, that the principal signed or acknowledged this durable power of attorney for health care in my presence, that the principal appears to be of sound mind and under no duress, fraud, or undue influence, and that I am not a health care provider or facility employee disqualified by Alaska law or the person appointed as agent by this document.
...
@sub ACKNOWLEDGMENT BY NOTARY PUBLIC
