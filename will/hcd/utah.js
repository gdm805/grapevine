...
window.HCD_STATES["Utah"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  UTAH
//  Converted word for word from your file Grapevine_HCD_Utah.docx (the controlled
...
The Principal executes this Advance Health Care Directive voluntarily.
...
I reasonably believe that the Principal’s act to create this power of attorney for health care is voluntary and knowing. I am not the Agent appointed by the Principal, the Agent’s spouse or cohabitant, and, if the Principal resides or is receiving care in a nursing home or assisted living facility, I am not an owner, operator, employee, or contractor of that facility. I was present as permitted by Utah law when the Principal signed this power of attorney or represented that it reflects the Principal’s wishes.

@line Witness Signature: ______________________________

@line Date: __________

@line Print Name: ______________________________
`;
