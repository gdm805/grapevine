...
window.HCD_STATES["Nevada"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  NEVADA
//  Converted word for word from your file Grapevine_HCD_Nevada.docx (the controlled
...
@center **NEVADA HEALTH CARE DIRECTIVE**

@center **ADVANCE HEALTH-CARE DIRECTIVE AND DURABLE POWER OF ATTORNEY FOR HEALTH CARE**
...
This Directive is intended to constitute an advance health-care directive and durable power of attorney for health care under NRS 162A.700 through 162A.870.
...
This Directive delays the Agent's health care decision-making authority until the Principal is incapacitated. The determination may be made in a writing or other record by an advanced practice registered nurse, physician, psychiatrist, or licensed psychologist as provided by Nevada law.
...
The Health Care Agent may not consent on the Principal's behalf to commitment or placement in a facility for treatment of mental illness, convulsive treatment, psychosurgery, sterilization, abortion, aversive intervention, experimental medical, biomedical or behavioral treatment, or participation in medical, biomedical or behavioral research, except as later law may expressly permit.
...
@line Qualified Witness Signature: ______________________________
