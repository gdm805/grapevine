...
window.HCD_STATES["Washington"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  WASHINGTON
//  Converted word for word from your file Grapevine_HCD_Washington.docx (the controlled
...
## Washington Health Care Directive Conditions

The Principal’s instructions concerning withholding or withdrawal of life-sustaining treatment shall apply only under the conditions recognized by Washington law, including terminal condition or permanent unconscious condition, and shall be implemented subject to the certifications required by law.
...
The Principal executes this Health Care Power of Attorney and Health Care Directive voluntarily.
...
We declare that the Principal signed or acknowledged this directive in our presence. We are not related to the Principal by blood or marriage, are not entitled to any portion of the Principal’s estate under a will or by operation of law, are not the attending physician or an employee of the attending physician or a health facility in which the Principal is a patient, and have no claim against the Principal’s estate.
...
I certify that I know or have satisfactory evidence that {{name}} is the person who appeared before me, and said person acknowledged that the person signed this instrument and acknowledged it to be the person’s free and voluntary act for the uses and purposes mentioned in this instrument.

@line Dated: ____________________

@line Signature of Notary: ______________________________

@line Print Name of Notary: ______________________________

@line Notary Public for the State of Washington, residing at ____________________
