...
window.HCD_STATES["North Dakota"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  NORTH DAKOTA
//  Converted word for word from your file Grapevine_HCD_North_Dakota.docx (the controlled
...
I understand this document allows me to do one or all of the following: name a health care agent to make health care decisions for me if I am unable to make and communicate decisions for myself; give health care instructions to guide others making decisions for me; and make an organ and tissue donation upon my death.
...
The Principal executes this Health Care Directive voluntarily.
...
We verify the Principal’s signature and declare that we are each at least eighteen years of age and satisfy the witness qualifications required by North Dakota law.
