...
window.HCD_STATES["Nebraska"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  NEBRASKA
//  Converted word for word from your file Grapevine_HCD_Nebraska.docx (the controlled
...
@set ask_ne_second_physician = yes
...
@center **NEBRASKA HEALTH CARE DIRECTIVE**

**POWER OF ATTORNEY FOR HEALTH CARE WITH HEALTH CARE INSTRUCTIONS**

**NEBRASKA STATUTORY WARNING**
...
This Directive is intended to constitute a Power of Attorney for Health Care under Neb. Rev. Stat. sections 30-3401 through 30-3432.
...
A contemporaneous objection by the Principal controls to the extent required by Nebraska law.
...
[[if ne_second_physician=YES]]

## Second Physician Confirmation

The Principal requires that a future determination of incapacity be confirmed by a second physician before the Attorney in Fact exercises health care decision authority.
...
@line Witness 1 Signature/Date: ______________________________

@line Printed Name: ___________________________________________

@line Witness 2 Signature/Date: ______________________________
...
@line On this ____ day of __________________, 20____, before me, ______________________________, a notary public in and for __________________ County, personally came {{name}}, personally to me known to be the identical person whose name is affixed to the above power of attorney for health care as principal, and I declare that the Principal appears in sound mind and not under duress or undue influence, that the Principal acknowledges the execution of the same to be the Principal's voluntary act and deed, and that I am not the attorney in fact or successor attorney in fact designated by this power of attorney for health care.
