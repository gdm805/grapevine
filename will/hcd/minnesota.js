...
window.HCD_STATES["Minnesota"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  MINNESOTA
//  Converted word for word from your file Grapevine_HCD_Minnesota.docx (the controlled
...
This Directive is intended to constitute a Health Care Directive under Minnesota Statutes chapter 145C.
...
@sub WITNESS VERIFICATION

The Agent or alternate Agent may not act as a witness. At least one witness must not be a health care provider providing direct care to the Principal or an employee of such a provider on the date of execution.
...
@line This record was acknowledged before me on __________________ by {{name}}.

@line Signature of Notarial Officer: ____________________________
