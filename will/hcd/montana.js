...
window.HCD_STATES["Montana"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  MONTANA
//  Converted word for word from your file Grapevine_HCD_Montana.docx (the controlled
...
This Directive is intended to state the Principal's health care instructions and to constitute a declaration under the Montana Rights of the Terminally Ill Act, MCA Title 50, chapter 9.
...
If the Principal has an incurable and irreversible condition that, without life-sustaining treatment, will cause death within a relatively short time in the opinion of the attending physician or advanced practice registered nurse, and the Principal is unable to make medical treatment decisions, the Principal directs treatment in accordance with the election below.
...
The declaration governing the withholding or withdrawal of life-sustaining treatment must be signed by the Principal, or another at the Principal's direction, and witnessed by two individuals.
