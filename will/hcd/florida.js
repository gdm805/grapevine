...
window.HCD_STATES["Florida"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  FLORIDA
//  Converted word for word from your file Grapevine_HCD_Florida.docx (the controlled
...
This Directive is intended to constitute a designation of health care surrogate and Living Will under Chapter 765, Florida Statutes.
...
If the Principal has a terminal condition, an end-stage condition, or is in a persistent vegetative state, and the statutory conditions for implementing the Living Will are satisfied, the Principal directs that life-prolonging procedures be withheld or withdrawn as selected below.
...
The designated Health Care Surrogate may not act as a witness. At least one witness must be neither the Principal’s spouse nor a blood relative of the Principal.
`;
