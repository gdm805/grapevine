...
window.HCD_STATES["Missouri"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  MISSOURI
//  Converted word for word from your file Grapevine_HCD_Missouri.docx (the controlled
...
@center **DURABLE POWER OF ATTORNEY FOR HEALTH CARE WITH DECLARATION**
...
This Directive is intended to coordinate a durable power of attorney for health care with the Principal's declaration concerning death-prolonging procedures under Missouri law.
...
If the Principal has a terminal condition and the requirements of Missouri law governing a declaration concerning death-prolonging procedures are satisfied, the Principal directs treatment in accordance with the election below.
...
WITNESS ATTESTATION — DECLARATION CONCERNING DEATH-PROLONGING PROCEDURES

The Principal signed this Declaration in our presence. Each witness is at least eighteen years of age and is not the person who signed the Declaration on behalf of and at the direction of the Principal.
...
@sub ACKNOWLEDGMENT — DURABLE POWER OF ATTORNEY FOR HEALTH CARE

@line STATE OF MISSOURI

@line County of {{county}}

@line On this ____ day of __________________, 20____, before me appeared {{name}}, to me known to be the person described in and who executed the foregoing Durable Power of Attorney for Health Care, and acknowledged that the Principal executed the same as the Principal's free act and deed.
