...
window.HCD_STATES["North Carolina"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  NORTH CAROLINA
//  Converted word for word from your file Grapevine_HCD_North_Carolina.docx (the controlled
...
**YOU SHOULD USE THIS DOCUMENT TO NAME A PERSON AS YOUR HEALTH CARE AGENT IF YOU ARE COMFORTABLE GIVING THAT PERSON BROAD AND SWEEPING POWERS TO MAKE HEALTH CARE DECISIONS FOR YOU. THERE IS NO LEGAL REQUIREMENT THAT ANYONE EXECUTE A HEALTH CARE POWER OF ATTORNEY.**

**EXPLANATION**

You have the right to name someone to make health care decisions for you when you cannot make or communicate those decisions. This form may be used to create a health care power of attorney, and meets the requirements of North Carolina law. However, you are not required to use this form, and North Carolina law allows the use of other forms that meet certain requirements. If you prepare your own health care power of attorney, you should be very careful to make sure it is consistent with North Carolina law.
...
If you want to use this form, you must complete it, sign it, and have your signature witnessed by two qualified witnesses and proved by a notary public. Do not sign this form until two witnesses and a notary public are present to watch you sign it.
...
By signing here, the Principal indicates that the Principal is mentally alert and competent, fully informed as to the contents of this document, and understands the import of the grant of powers to the Health Care Agent.
...
@sub NOTARIAL CERTIFICATE

@line ________________ COUNTY, ________________ STATE

Sworn to (or affirmed) and subscribed before me this day by {{name}} and the two witnesses identified above.

@line Date: ____________________

@line (Official Seal)  Signature of Notary Public: ______________________________

@line Printed or typed name: ______________________________
