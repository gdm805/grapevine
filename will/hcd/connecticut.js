...
window.HCD_STATES["Connecticut"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  CONNECTICUT
//  Converted word for word from your file Grapevine_HCD_Connecticut.docx (the controlled
...
@set ask_ct_dmhas = yes
@set ask_ct_dds = yes
@set ask_ct_pregnancy = yes
...
This Directive is intended to constitute an advance health care directive and appointment of health care representative under Conn. Gen. Stat. §§ 19a-570 through 19a-580g, including §§ 19a-575a and 19a-576.
...
[[if ct_pregnancy=SUPPORT_LIVE_BIRTH]]

If the Principal is pregnant, the Principal intends to accept life-support systems if the attending physician or advanced practice registered nurse believes doing so would allow the fetus to reach a live birth.

[[elif ct_pregnancy=APPLY_WITHOUT_MODIFICATION]]

The Principal intends this Directive to apply without modification during pregnancy to the extent permitted by Connecticut law.

[[elif ct_pregnancy=CUSTOM]]
...
If the Principal resides in a facility operated or licensed by the Connecticut Department of Mental Health and Addiction Services, apply the additional witness qualifications required by Conn. Gen. Stat. § 19a-576(b).
...
@line Number and Street: ______________________________________

@line City, State and Zip Code: _________________________________
...
@sub DMHAS FACILITY WITNESS REQUIREMENT

At least one witness must be an individual not affiliated with the facility, and at least one witness must be a physician, advanced practice registered nurse, or licensed clinical psychologist with specialized training in treating mental illness.

[[end]]

[[if ct_dds]]

@sub DDS FACILITY WITNESS REQUIREMENT

At least one witness must be an individual not affiliated with the facility, and at least one witness must be a physician, advanced practice registered nurse, or licensed clinical psychologist with specialized training in developmental disabilities.
