...
window.HCD_STATES["Maine"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  MAINE
//  Converted word for word from your file Grapevine_HCD_Maine.docx (the controlled
...
This Directive is intended to constitute an advance health care directive under Maine Title 18-C, Part 8, Uniform Health Care Decisions Act.
...
@sub SIGNATURES OF WITNESSES

The power of attorney for health care must be signed by the Principal and two witnesses. Ordinary execution is in person; Maine's special remote-facility procedure applies only when its statutory conditions are satisfied.
