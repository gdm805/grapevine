...
window.HCD_STATES["Hawaii"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  HAWAII
//  Converted word for word from your file Grapevine_HCD_Hawaii.docx (the controlled
...
This Directive is intended to constitute an advance health-care directive under Hawaii Revised Statutes Chapter 327E.
...
Unless otherwise specified in this written Directive, a determination that the Principal lacks or has recovered capacity shall be made by the primary physician as provided by HRS § 327E-3(f).
...
@line Address: __________________________________

@line Printed Name: ______________________________

@line City/State: _____________________________________________
