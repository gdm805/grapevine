...
window.HCD_STATES["New Hampshire"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  NEW HAMPSHIRE
//  Converted word for word from your file Grapevine_HCD_New_Hampshire.docx (the controlled
//  state document). Same rules as will/dpoa-template.js. To change this state, edit this file only.
// ==========================================================================
@set exec_choice = yes
@set exec_route_default = 
@set exec_routes = NOTARY_OR_JUSTICE_OF_PEACE,WITNESSES
...
@center **NEW HAMPSHIRE HEALTH CARE DIRECTIVE**
...
This Directive is intended to constitute a New Hampshire advance directive under RSA chapter 137-J, including a durable power of attorney for health care and living will.
...
The Health Care Agent's authority becomes effective when the attending practitioner examines the Principal and certifies that the Principal lacks capacity to make health care decisions, as provided by RSA chapter 137-J.
...
[[elif exec_route=NOTARY_OR_JUSTICE_OF_PEACE]]

@sub ACKNOWLEDGMENT — NOTARY PUBLIC OR JUSTICE OF THE PEACE

@line STATE OF NEW HAMPSHIRE

@line COUNTY OF {{county}}

@line The foregoing advance directive was acknowledged before me this ____ day of __________________, 20____, by {{name}} (the “Principal”).

@line Notary Public/Justice of the Peace: ______________________________
