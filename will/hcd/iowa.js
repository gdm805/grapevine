...
window.HCD_STATES["Iowa"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  IOWA
//  Converted word for word from your file Grapevine_HCD_Iowa.docx (the controlled
...
This Directive is intended to constitute a Durable Power of Attorney for Health Care under Iowa Code Chapter 144B, together with the Principal’s health care instructions.
...
We witnessed the Principal’s signing in the presence of each other and the Principal. Neither witness is the attending health care provider, an employee of that provider, the Attorney in Fact, or under age eighteen. At least one witness is not related to the Principal within the third degree by blood, marriage, or adoption.
...
@line This record was acknowledged before me on __________________ (Date) by {{name}}.
