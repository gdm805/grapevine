...
window.HCD_STATES["New Jersey"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  NEW JERSEY
//  Converted word for word from your file Grapevine_HCD_New_Jersey.docx (the controlled
//  state document). Same rules as will/dpoa-template.js. To change this state, edit this file only.
// ==========================================================================
@set exec_choice = yes
@set exec_route_default = 
@set exec_routes = ACKNOWLEDGMENT,WITNESSES
...
@center **ADVANCE DIRECTIVE FOR HEALTH CARE — PROXY AND INSTRUCTION DIRECTIVE**
...
This Directive is intended to constitute an advance directive for health care under the New Jersey Advance Directives for Health Care Act, N.J.S.A. 26:2H-53 et seq., including a proxy directive and instruction directive.
...
We attest that the Principal is of sound mind and free of duress and undue influence. Neither witness is the designated Health Care Representative.
...
[[elif exec_route=ACKNOWLEDGMENT]]

@sub ACKNOWLEDGMENT

The Principal acknowledges this Advance Directive before a notary public, attorney at law, or other person authorized to administer oaths under New Jersey law.

@line Acknowledged by {{name}} on ______________________________.

@line Authorized Officer Signature: ____________________________

@line Title/Capacity: _________________________________________
