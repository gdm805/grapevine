...
window.HCD_STATES["Oregon"] = String.raw`
// ==========================================================================
//  GRAPEVINE  |  HEALTH CARE DIRECTIVE  |  OREGON
//  Converted word for word from your file Grapevine_HCD_Oregon.docx (the controlled
...
This Advance Directive form allows you to share your values, beliefs, goals and wishes for health care if you are not able to express them yourself, and to name a person to make your health care decisions if you could not make them for yourself. This person is called your health care representative and they must agree to act in this role.
...
This Advance Directive is not the same as Portable Orders for Life Sustaining Treatment (POLST).

# Declaration and Purpose

## Health Care Directive

This Health Care Directive states the Principal's instructions concerning health care and appoints a Health Care Representative to make health care decisions for the Principal when authorized by this Directive and applicable law.
...
@item (b) authorize the Health Care Representative to make health care decisions for the Principal to the fullest extent authorized by this Directive and applicable law;
...
No authority granted to a Health Care Representative under this Directive limits the Principal's right to make or communicate health care decisions while the Principal has capacity to do so.

# Appointment of Health Care Agent

## Appointment of Health Care Representative

The Principal appoints the following person to serve as Health Care Representative:
...
In addition to the Health Care Representative named above, I appoint the following persons to serve at the same time. Each person named in this paragraph is my Health Care Representative, and all of them together are my "co-agents":
...
## Successor Health Care Representatives

If the Health Care Representative named in Section 2.01 dies, resigns, declines to serve, is unable or unwilling to serve, becomes legally disqualified, or otherwise ceases to serve, the following persons shall serve as Successor Health Care Representatives in the order listed:
...
A Successor Health Care Representative shall have the same authority as the originally appointed Health Care Representative unless this Directive expressly provides otherwise.
...
A person appointed as Health Care Representative may serve only if legally eligible to serve under the law applicable when the person's authority is exercised.

If an appointed person is legally disqualified from serving, that person shall be treated as unable to serve, and the next eligible Successor Health Care Representative shall serve.

## Acceptance

A person appointed as Health Care Representative accepts the appointment by acting under this Directive unless applicable law requires another method of acceptance.
...
The Health Care Representative may assist the Principal, communicate the Principal's decisions, obtain information as authorized by this Directive, and otherwise act as permitted by the Principal and applicable law, but shall not override a health care decision made by the Principal while the Principal has capacity to make that decision.

## Effectiveness Upon Incapacity

Except for authority that this Directive or applicable law permits to be exercised earlier, the Health Care Representative's authority to make health care decisions becomes effective when the Principal is determined to lack capacity to make the health care decision at issue.
...
If the Principal regains capacity to make a health care decision, the Health Care Representative's authority to make that decision shall cease while the Principal retains that capacity.

A determination that the Principal has regained capacity shall be made as required by applicable law.

If the Principal later again lacks capacity, the Health Care Representative's authority may again become effective without the need to execute a new Health Care Directive.

## Health Information Authority

Before the Health Care Representative's decision-making authority becomes effective, the Agent may obtain health and medical information to the extent authorized by Article Ten and applicable law.
...
Subject to the Principal's instructions and limitations in this Directive and applicable law, the Health Care Representative may make any health care decision that the Principal could make if the Principal had capacity to make that decision.

## Specific Powers

Without limiting the general authority granted by Section 4.01, the Health Care Representative may, to the extent permitted by applicable law:
...
@item (l) transfer the Principal's care to another provider or facility when reasonably necessary to carry out the Principal's instructions or the Health Care Representative's authorized decision;
...
The Health Care Representative shall not:

@item (a) act contrary to an instruction of the Principal that is binding under this Directive and applicable law;

@item (b) exercise authority expressly withheld from the Health Care Representative by this Directive;
...
This Directive does not grant the Health Care Representative general authority over the Principal's property or financial affairs.

The Health Care Representative may execute health-care-related consents, admissions documents, releases, and similar instruments reasonably necessary to carry out an authorized health care decision to the extent permitted by applicable law. This limited authority does not independently grant the Health Care Representative general control over the Principal's accounts or property.

# Standard for Health Care Decisions

## Controlling Instructions

The Health Care Representative shall make health care decisions in accordance with the Principal's instructions contained in this Directive and any other health care instructions of the Principal that are known to the Agent and legally effective.
...
If the Principal has not given a controlling instruction concerning a particular health care decision, the Health Care Representative shall make the decision in accordance with the Principal's wishes to the extent those wishes are reasonably known.

In determining the Principal's wishes, the Health Care Representative may consider the Principal's previously expressed preferences, personal values, religious or spiritual beliefs, treatment goals, attitudes toward independence and quality of life, and other information reasonably known to the Agent.

## Best Interests

If the Principal's wishes concerning a health care decision cannot reasonably be determined, the Health Care Representative shall act in the Principal's best interests.

In determining the Principal's best interests, the Health Care Representative may consider:
...
The Health Care Representative and health care providers shall, to the extent reasonably practicable, involve the Principal in health care decisions even when the Principal lacks full capacity to make the decision independently.
...
Specific health care instructions stated by the Principal are binding on the Health Care Representative and health care providers to the fullest extent permitted by applicable law.

Statements of the Principal's values, preferences, goals, and beliefs shall guide the Health Care Representative when applying those instructions and when making decisions not specifically addressed by the Principal.

The Health Care Representative may exercise reasonable judgment in interpreting an instruction and applying it to circumstances not expressly anticipated by the Principal but may not knowingly disregard a controlling instruction.
...
Additional limitations on the authority of the Health Care Representative:
...
Religious, spiritual, ethical, cultural, or personal values the Health Care Representative should consider:
...
The Principal authorizes the Health Care Representative to decide whether life-sustaining treatment should be provided, withheld, or withdrawn.

The Health Care Representative shall make that decision under Article Five after considering the Principal's medical condition, prognosis, likelihood of meaningful recovery, burdens and benefits of treatment, relief of suffering, and the Principal's known wishes and values.

[[end]]

## Trial of Treatment

When consistent with the Principal's controlling treatment instructions, a reasonable time-limited trial of a life-sustaining treatment may be undertaken if the likely benefit is uncertain and the Health Care Representative and health care providers reasonably believe the treatment may permit recovery or materially improve the Principal's condition.
...
The Principal authorizes the Health Care Representative to decide whether artificially administered nutrition should be provided, continued, withheld, or withdrawn under the decision standards stated in Article Five.
...
The Principal authorizes the Health Care Representative to decide whether artificially administered hydration should be provided, continued, withheld, or withdrawn under the decision standards stated in Article Five.
...
The Health Care Representative may authorize hospice care, palliative care, comfort-focused treatment, and other services designed primarily to promote comfort and quality of life when consistent with the Principal's instructions and medical circumstances.
...
When medically appropriate and reasonably practicable, the Health Care Representative may consider the Principal's preference to receive care in the least restrictive and most comfortable setting suitable to the Principal's needs, including the Principal's home, hospice, assisted living facility, nursing facility, hospital, or other appropriate setting.

# Mental Health Care

## General Mental Health Authority

Subject to the Principal's instructions in this Directive and applicable law, the Health Care Representative may make decisions concerning the Principal's mental and behavioral health care to the extent such authority may lawfully be delegated to a health care agent.

## Scope of Authority

To the extent permitted by applicable law, the Health Care Representative may:
...
If the Principal has executed such a directive, the Health Care Representative shall act consistently with that directive to the extent required by applicable law.

# Health Information and Medical Records

## Health Information Authority

The Principal authorizes the Health Care Representative to request, inspect, review, receive, copy, and disclose health and medical information concerning the Principal to the extent reasonably necessary to carry out this Directive.

For purposes of the Health Insurance Portability and Accountability Act of 1996 and other applicable health-information laws, the Principal intends the acting Health Care Representative to be treated as the Principal's personal representative to the extent permitted by law.

## Immediate Information Access

The Health Care Representative may obtain health information before the Agent's health care decision-making authority becomes effective to the extent permitted by applicable law, including information reasonably necessary to determine whether the conditions for activation of that authority have occurred.

## Implementation

The Health Care Representative may execute releases, authorizations, consents, and other documents reasonably necessary to obtain or disclose health information and may share information with health care providers, fiduciaries, caregivers, attorneys, and other persons when reasonably necessary to carry out the Principal's health care, personal care, incapacity planning, or other lawful interests.
...
If a court determines that a guardian of the person or other court-appointed fiduciary responsible for the Principal's personal or health care decisions must be appointed, the Principal nominates the then-acting Health Care Representative to serve in that capacity to the extent permitted by applicable law.

If the acting Health Care Representative is unable, unwilling, or legally ineligible to serve, the Principal nominates the Successor Health Care Representatives in the order designated in Article Two.

## Preference for Agent Authority

To the extent permitted by applicable law, the Principal prefers that the authority granted under this Directive remain effective and that appointment of a guardian or similar fiduciary not unnecessarily restrict or terminate the authority of the Health Care Representative.
...
Except for authority that survives the Principal's death under this Directive or applicable law, the Health Care Representative's authority to make health care decisions terminates upon the Principal's death.
...
The Health Care Representative may take actions reasonably necessary to carry out the Principal's anatomical-gift instructions to the extent permitted by applicable law.

[[elif anatomical_gift=AGENT_DECIDES]]

The Principal authorizes the Health Care Representative to make decisions concerning anatomical gifts after the Principal's death to the extent permitted by applicable law.
...
A change in the Principal's marital or domestic relationship shall affect the authority of an appointed Health Care Representative only as provided by applicable law or an express provision of this Directive.
...
A person who in good faith relies upon this Directive or upon a representation of the Health Care Representative concerning the Agent's authority may do so to the extent permitted by applicable law.

## No Liability for Health Care Costs

A person serving as Health Care Representative does not become personally responsible for the Principal's health care expenses solely because the person acts as Health Care Representative.
...
This Directive shall be interpreted to carry out the Principal's expressed health care instructions and to give the Health Care Representative the authority intended by the Principal to the fullest extent permitted by applicable law.

Section 13.10 — Oregon Representative Acceptance

An appointment of a Health Care Representative or Alternate Health Care Representative is not effective until accepted as permitted by Oregon law. The acceptance blocks appear with the execution package below.

Execution follows on the next page.

#! EXECUTION

The Principal executes this Oregon Advance Directive voluntarily.
...
We witnessed the Principal sign or acknowledge this Advance Directive and are qualified to serve under Oregon law.

@line Witness 1 Signature: ____________________

@line Date: __________

@line Witness 2 Signature: ____________________
...
@line This record was acknowledged before me on __________ by {{name}}.

@line Notary Public: ______________________________

@line My commission expires: ____________________

[[end]]

@sub ACCEPTANCE OF APPOINTMENT AS HEALTH CARE REPRESENTATIVE

I accept appointment as the Principal’s Health Care Representative and agree to serve in accordance with this Advance Directive and Oregon law.

@line Health Care Representative Signature: ____________________

@line Date: __________

@line Printed Name: {{agent}}

[[if has_successors]]

@line Alternate Health Care Representative Signature: ____________________
